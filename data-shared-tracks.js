// ---------------------------------------------------------
// Unica fonte condivisa per le playlist dei Final Fantasy usate in
// piu' punti del sito (Il Filo Nascosto, Diari di Gioco, e il menu
// playlist di Storie Senza Cornice) - prima erano copie separate in
// file diversi, stessa lista ma triplicata; ora un solo posto da
// aggiornare se cambia qualcosa.
// ---------------------------------------------------------
const SHARED_FFVII_TRACKS = [
