...
const STRINGS = {
  it: {
    ...
    spoilerAlert: "Ogni pagina contiene spoiler su trame e finali: procedi solo se hai già finito i titoli o non ti dispiace.",
  ...
  en: {
    ...
    landingIntro: "Theories, behind-the-scenes details, and clues that slip past a first playthrough, hidden inside the most beloved video game sagas.",
    landingQuote: "With theories I start from a suspicion, I search, I verify, and only at the end do I write what actually holds up. With hidden stories I start from the certainty that something is there, and all I look for is a way to piece it back together.",
    landingSignature: "— Sakrem",
    spoilerAlert: "Every page contains spoilers on plots and endings: proceed only if you've finished the games or don't mind.",
