...
const STRINGS = {
  it: {
    ...
    landingQuote: "Ogni teoria comincia da un dettaglio che sembra non contare niente. Poi inizio a tirare il filo, e non riesco più a fermarmi finché non arrivo in fondo — anche se in fondo, a volte, non c'è davvero niente.",
  ...
  en: {
    ...
    landingQuote: "Every theory starts from a detail that seems to mean nothing. Then I start pulling the thread, and I can't stop until I reach the end — even when, sometimes, there's nothing there at all.",
    landingSignature: "— Sakrem",
