    ...
    universes: [
      {
        ...
        entries: [
          { id: "birth-of-sanctuary", type: "STORIA", typeEn: "STORY", year: "Secoli prima di Diablo", yearEn: "Centuries before Diablo", noAvatar: true,
            ...
            synopsis: {
              it: "Secoli prima degli eventi di Diablo, l'arcangelo Inarius e la demonessa Lilith, entrambi disillusi dal Conflitto Eterno tra Paradiso e Inferi, sottraggono un frammento della Pietra del Mondo per creare Sanctuarium, un regno nascosto a entrambe le fazioni. Dalla loro unione nascono i Nefalem, ibridi angelo-demone più potenti sia degli angeli che dei demoni. Temendo una loro futura ribellione, angeli e demoni rinnegati tentano di sterminarli; Lilith li difende uccidendo i propri stessi alleati, ma Inarius, incapace di ucciderla, la bandisce da Sanctuarium e indebolisce la stirpe dei Nefalem, che nel corso delle generazioni si affievolisce fino a diventare la razza umana. Quando i Primi Maligni Diablo, Mefisto e Baal vengono a loro volta esiliati a Sanctuarium dopo una rivolta scoppiata nell'Inferno, l'arcangelo Tyrael forma l'ordine degli Horadrim e forgia le Pietre dell'Anima, ricavate dalla stessa Pietra del Mondo, per dare loro la caccia. Gli Horadrim imprigionano Mefisto sotto un tempio nella giungla di Kehjistan e Baal grazie al sacrificio di Tal Rasha, che ne rinchiude l'essenza nel proprio corpo; Diablo viene infine catturato dal condottiero Jered Cain e la sua Pietra dell'Anima sepolta sotto la cattedrale di Tristram. Secoli dopo, l'arcivescovo Lazarus, corrotto dal culto della Triuna, dissotterra la pietra e libera Diablo, dando inizio agli eventi del primo capitolo della saga.",
          ...
          { id: "diablo-2", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "1263 – 1265", releaseYear: "2000 (Remaster: 2021)", releaseYearEn: "2000 (Remaster: 2021)",
            ...
            synopsis: {
              it: "L'eroe del primo gioco, ormai posseduto da Diablo, semina il caos attraverso il continente in cerca dei propri fratelli Primi Maligni, Mefisto e Baal, per riunire la Trinità del Terrore. Un nuovo gruppo di eroi lo insegue attraverso quattro atti e altrettanti continenti, sconfiggendo infine sia Diablo che Mefisto.",
          ...
          { id: "lord-of-destruction", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "1265", releaseYear: "2001 (Remaster: 2021)", releaseYearEn: "2001 (Remaster: 2021)",
            ...
            synopsis: {
              it: "Baal, ultimo dei tre fratelli rimasto libero, marcia verso la Worldstone, capace di alterare la realtà stessa, per corromperla e completare il piano dei Primi Maligni. Gli eroi lo affrontano al Monte Arreat; per impedire che la pietra venga sfruttata di nuovo, l'angelo Tyrael la distrugge lui stesso, alterando per sempre l'equilibrio tra Paradiso e Inferi.",
          ...
          { id: "diablo-4", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "1336 circa (50 anni dopo Reaper of Souls)", yearEn: "c. 1336 (50 years after Reaper of Souls)", releaseYear: "2023", releaseYearEn: "2023",
            ...
            synopsis: {
              it: "Lilith, figlia di Mefisto e co-creatrice di Sanctuarium stessa insieme all'angelo Inarius, viene resuscitata da un culto di seguaci e tenta di riconquistare il mondo che un tempo aveva contribuito a plasmare. Un nuovo eroe la insegue attraverso Sanctuarium devastato dalla sua corruzione, affrontandola infine in uno scontro che la relega, sconfitta ma non uccisa, in un regno intermedio.",
