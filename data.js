...
const GAMES = {
    ...
    universes: [
      {
        ...
        entries: [
          ...
          { id: "distensione-osea-yuktobania", type: "STORIA", typeEn: "STORY", year: "2005 – 2010", yearEn: "2005 – 2010",
            ...
            synopsis: {
              it: "Nel dopoguerra seguito alla Guerra Continentale, Osea e Yuktobania, un tempo alleate e poi rivali sempre più diffidenti, avviano un percorso di riavvicinamento diplomatico senza precedenti: riducono gli arsenali militari, smantellano parte delle proprie armi di distruzione di massa e collaborano persino a progetti di sviluppo spaziale congiunti. Per alcuni anni la distensione tiene, e le due nazioni sembrano avviate verso una pace duratura. È proprio questa fiducia reciproca, faticosamente ricostruita, a rendere entrambi i paesi vulnerabili quando qualcuno deciderà di infrangerla con un attacco a sorpresa.",
      ...
      },
      {
        ...
        entries: [
          { id: "ikaros-in-the-sky", type: "ROMANZO", typeEn: "NOVEL", year: "2002", yearEn: "2002", releaseYear: "2012", releaseYearEn: "2012",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Ace%20Combat%20Ikaros%20in%20the%20Sky.jpg",
            synopsis: {
              it: "Nel 2002 il Giappone subisce l'incursione di un gruppo di velivoli non identificati: l'incidente porta la Japan Air Self-Defense Force ad avviare il programma ASF-X per lo sviluppo di un nuovo caccia da difesa nazionale. Il sottotenente Kei Nagase, dello Squadrone Congiunto di Test e Valutazione (personaggio omonimo ma del tutto distinto dalla pilota Kei Nagase di Ace Combat 5, appartenente a un'altra continuità), viene scelta come pilota collaudatore dello Shinden II, il prototipo sperimentale nato dal programma, affiancata dal rivale e collega Wataru Asano. Le prove di volo del velivolo si intrecciano con gli intrighi politici e industriali legati al progetto: la Repubblica, potenza rivale del Giappone che sta sviluppando in proprio il caccia QFA-44 Nosferatu, ordina all'alto ufficiale Da Xiao di far intercettare e catturare la navetta spaziale statunitense SSTO Armstrong, minacciata dai mercenari al soldo della Repubblica A Xi e Jian Qiang. Nagase e Asano intervengono a difesa dell'Armstrong, respingendo l'attacco e permettendo alla navetta di atterrare in sicurezza a Haneda, mentre A Xi è costretto alla fuga dopo essere rimasto colpito dall'abilità di volo di Nagase, sventando così il tentativo della Repubblica di impossessarsi della tecnologia americana e di replicare i progressi giapponesi nel campo dei caccia di nuova generazione.",
              en: "In 2002 Japan suffers an incursion by a group of unidentified aircraft: the incident leads the Japan Air Self-Defense Force to launch the ASF-X programme to develop a new fighter for national defense. Second Lieutenant Kei Nagase, of the Joint Test and Evaluation Squadron — a character sharing her name with, but entirely distinct from, the pilot Kei Nagase of Ace Combat 5, who belongs to a different continuity — is chosen as test pilot for the Shinden II, the experimental prototype born from the programme, alongside her rival and colleague Wataru Asano. The aircraft's flight trials become entangled with the political and industrial intrigue surrounding the project: the Republic, a rival power to Japan developing its own QFA-44 Nosferatu fighter, orders high-ranking officer Da Xiao to intercept and capture the American SSTO spacecraft Armstrong, threatened by Republic-hired mercenaries A Xi and Jian Qiang. Nagase and Asano step in to defend the Armstrong, repelling the attack and allowing the spacecraft to land safely at Haneda, while A Xi is forced to flee after being impressed by Nagase's flying skill — thwarting the Republic's attempt to seize American technology and replicate Japan's advances in next-generation fighter aircraft."
            }
          },
          { id: "joint-assault", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "2010 – 2011", yearEn: "2010 – 2011", releaseYear: "2010", releaseYearEn: "2010",
            title: { it: "Ace Combat: Joint Assault", en: "Ace Combat: Joint Assault" },
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Ace%20Combat%20Joint%20Assault.jpg",
            synopsis: {
              it: "Tra la fine del 2010 e l'inizio del 2011, il pilota noto come Antares One entra a far parte dello Squadrone Antares della compagnia militare privata Martinez Security, al comando del tenente colonnello Frederick Burford. Durante un'esercitazione congiunta con la Settima Flotta statunitense e le Forze di Autodifesa giapponesi nel Pacifico, lo squadrone viene attaccato dai caccia del gruppo terroristico Valahia, comandato dal colonnello rumeno Nicolae Dumitrescu, che colpisce subito dopo Tokyo con la fortezza volante Orgoi, dichiarando guerra al mondo intero. Per scagionarsi dal sospetto di collusione, Martinez Security aderisce alla coalizione internazionale International Union Peacekeeping Force (IUPF) e lo Squadrone Antares viene inviato a contrastare la Valahia su più fronti (tra Egitto, Emirati Arabi Uniti, Turchia e i cieli di Londra, dove viene abbattuta la portaerei volante Spiridus), anche dopo la defezione dello Squadrone Rigel, passato dalla parte del nemico per denaro.\n\nNel corso della campagna Antares scorta anche il jet privato dell'assicuratore internazionale Andre Olivieri in una missione contro i silos missilistici della Valahia in Asia Centrale, senza sapere che è proprio Olivieri, sopravvissuto alla grande recessione grazie ai propri affari assicurativi, il vero burattinaio del conflitto: dietro le quinte finanzia sia la Valahia sia la stessa IUPF, nell'ambito di un piano segreto chiamato Golden Axe, pensato per fomentare una guerra prolungata e far crescere a dismisura la domanda di assicurazioni belliche. Nello scontro decisivo, lo Squadrone Antares abbatte lo Squadrone Varcolac e uccide Dumitrescu nel crollo del complesso dei silos, per poi risalire fino a Olivieri: nella battaglia finale sopra Nevada e San Francisco, distrugge il data center sotterraneo della sua compagnia, uccidendo Olivieri nell'esplosione ed esponendo pubblicamente il piano Golden Axe, che pone fine alla guerra.",
              en: "Between late 2010 and early 2011, a pilot known as Antares One joins Antares Squadron, part of the private military company Martinez Security, under the command of Lieutenant Colonel Frederick Burford. During a joint exercise with the U.S. Seventh Fleet and the Japan Self-Defense Forces in the Pacific, the squadron is attacked by fighters of the terrorist group Valahia, commanded by Romanian colonel Nicolae Dumitrescu, who then strikes Tokyo with the flying fortress Orgoi, declaring war on the entire world. To clear its name from suspicion of collusion, Martinez Security joins the international coalition International Union Peacekeeping Force (IUPF), and Antares Squadron is deployed against Valahia on multiple fronts — across Egypt, the United Arab Emirates, Turkey, and the skies over London, where the flying carrier Spiridus is shot down — even after Rigel Squadron defects to the enemy for money.\n\nDuring the campaign, Antares also escorts the private jet of international insurer Andre Olivieri on a mission against Valahia's missile silos in Central Asia, unaware that Olivieri — whose insurance business survived the Great Recession — is the real mastermind behind the conflict: behind the scenes he secretly finances both Valahia and the IUPF itself, as part of a covert scheme called the Golden Axe Plan, designed to fuel a prolonged war and drive up demand for war insurance. In the decisive confrontation, Antares Squadron shoots down Varcolac Squadron and kills Dumitrescu as the silo complex collapses, then traces the conspiracy back to Olivieri: in the final battle over Nevada and San Francisco, it destroys his company's underground data center, killing Olivieri in the explosion and publicly exposing the Golden Axe Plan, bringing the war to an end."
            }
          },
          { id: "the-last-ace", type: "ROMANZO", typeEn: "NOVEL", year: "Poco prima di Ace Combat: Assault Horizon", yearEn: "Shortly before Ace Combat: Assault Horizon", releaseYear: "2011", releaseYearEn: "2011",
            title: { it: "The Last Ace", en: "The Last Ace" },
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Ace%20Combat%20The%20Last%20Ace.jpg",
            synopsis: {
              it: "Racconto breve che fa da prequel ad Ace Combat: Assault Horizon; le fonti ufficiali non specificano un anno narrativo preciso, ma il racconto è ambientato dopo l'intervento in Libia del 2011 e poco prima degli eventi di Assault Horizon (2015). Il tenente colonnello dell'USAF William \"Brass\" Bishop, veterano di tre guerre già passato per la Seconda Guerra del Golfo (2003) e per l'intervento in Libia (2011), presta servizio come pilota collaudatore di \"Righteous\", una versione modificata e potenziata dell'F-22A Raptor dotata di sistemi di controllo assistiti da intelligenza artificiale. Durante uno dei voli di prova, Bishop ripercorre con la memoria i propri anni di combattimento, dalla guerra in Bosnia in poi, prima di accettare l'incarico che lo porterà al comando del contingente statunitense della Task Force 108, la forza multinazionale a guida NATO destinata a intervenire contro la ribellione in atto nell'Africa Orientale, l'antefatto diretto degli eventi di Assault Horizon.",
              en: "A short story serving as a prequel to Ace Combat: Assault Horizon; official sources do not specify a precise narrative year, but the story is set after the 2011 intervention in Libya and shortly before the events of Assault Horizon (2015). USAF Lieutenant Colonel William \"Brass\" Bishop, a veteran of three wars who has already fought in the Second Gulf War (2003) and the Libya intervention (2011), serves as a test pilot for \"Righteous,\" a modified, upgraded version of the F-22A Raptor fitted with AI-assisted control systems. During one of the test flights, Bishop's mind wanders back through his years of combat, starting with the war in Bosnia, before he accepts the assignment that will put him in command of the American contingent of Task Force 108, the NATO-led multinational force set to intervene against the ongoing rebellion in East Africa — the direct lead-in to the events of Assault Horizon."
            }
          },
          { id: "assault-horizon", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "2015 – 2016", yearEn: "2015 – 2016", releaseYear: "2011", releaseYearEn: "2011",
            title: { it: "Ace Combat: Assault Horizon", en: "Ace Combat: Assault Horizon" },
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Ace%20Combat%20Assault%20Horizon.jpg",
            synopsis: {
              it: "Nel 2015, un'insolita ondata di rivolte nell'Africa Orientale, guidata dal gruppo ribelle SRN, travolge rapidamente i governi della regione, che chiedono l'intervento delle Nazioni Unite. La NATO risponde costituendo la Task Force 108, unità multinazionale che riunisce piloti e comandanti di più paesi (tra cui Stati Uniti e Russia) al comando, per il contingente americano, del tenente colonnello William \"Brass\" Bishop dello Squadrone Warwolf. Nel corso delle operazioni contro l'SRN emerge che i ribelli dispongono di \"Trinity\", un missile da crociera con una potenza distruttiva senza precedenti. Durante l'inseguimento dell'arma, lo Squadrone Warwolf viene attaccato a tradimento dal contingente russo della Task Force 108, corrotto dalla criminalità organizzata Blatnoi: tra i traditori spicca l'asso russo Andrei Markov, che per poco non uccide Bishop in duello.\n\nLa Task Force 108 e le forze russe rimaste leali avanzano fino a Mosca per liberarla dai golpisti filo-Blatnoi della Nuova Federazione Russa (NRF), che però lancia un missile Trinity contro la colonna d'attacco, con un secondo ordigno già in arrivo: Bishop abbatte il bombardiere che lo trasporta e sconfigge Markov in duello, apparentemente uccidendolo. Quando il generale Stagleishov offre l'immunità politica in cambio della resa totale e dell'ultimo Trinity rimasto all'NRF, Markov, in realtà sopravvissuto, lo uccide e ne assume il comando, mobilitando l'NRF per colpire gli Stati Uniti in un attacco di vendetta legato alla morte della moglie, uccisa anni prima in un raid aereo americano durante la guerra in Bosnia. La Task Force 108 respinge il grosso attacco di Markov su Miami (dove il gregario Guts si sacrifica facendo scudo a Bishop col proprio velivolo prima di riuscire comunque a eiettarsi) e lo insegue fino a Washington, dove Markov tenta un ultimo attacco con Trinity contro la Casa Bianca. Danneggiato nello scontro precedente, è costretto a lanciare l'ordigno da distanza ravvicinata: Bishop lo affronta un'ultima volta e un colpo di cannone perfora la testata, facendola esplodere innocuamente sopra il bacino del National Mall. Bishop abbatte e uccide Markov, ponendo fine alla rivolta e sventando l'attacco.",
              en: "In 2015, an unusually large wave of unrest in East Africa, led by the SRN rebel group, quickly overwhelms the region's governments, who call for United Nations intervention. NATO responds by forming Task Force 108, a multinational unit bringing together pilots and commanders from several countries — including the United States and Russia — with the American contingent commanded by Lieutenant Colonel William \"Brass\" Bishop of Warwolf Squadron. During operations against the SRN it emerges that the rebels possess \"Trinity,\" a cruise missile of unprecedented destructive power. While pursuing the weapon, Warwolf Squadron is ambushed by the Russian contingent of Task Force 108, corrupted by the Blatnoi organized crime syndicate: among the traitors is Russian ace Andrei Markov, who very nearly kills Bishop in a dogfight.\n\nTask Force 108 and the remaining loyalist Russian forces advance on Moscow to liberate it from the pro-Blatnoi coup plotters of the New Russian Federation (NRF), which fires a Trinity missile at the advancing column, with a second warhead already inbound: Bishop shoots down the bomber carrying it and defeats Markov in a duel, seemingly killing him. When General Stagleishov offers the NRF political immunity in exchange for total surrender and its last remaining Trinity missile, Markov — in fact still alive — kills him, seizes command, and mobilizes the NRF to strike the United States in an act of revenge for his wife, killed years earlier in an American airstrike during the war in Bosnia. Task Force 108 repels Markov's major assault on Miami — where wingman Guts shields Bishop with his own aircraft before managing to eject — and pursues him to Washington, D.C., where Markov attempts a final Trinity strike on the White House. Damaged in the earlier clash, he is forced to launch the warhead at close range: Bishop faces him one last time, and a cannon round pierces the warhead, detonating it harmlessly over the National Mall's reflecting pool. Bishop shoots down and kills Markov, ending the uprising and averting the attack."
            }
          }
        ]
      }
    ...
    universes: [
      {
        ...
        entries: [
          ...
          },
          {
            ...
            synopsis: {
              it: "Piccolo gioco promozionale sviluppato durante la produzione di Alone in the Dark 2, distribuito gratuitamente a Natale 1993. Protagonista: Grace Saunders, la bambina che verrà rapita in AitD2. La notte di Halloween, Grace è in giro per il dolcetto o scherzetto quando bussa alla porta di un negozio di giocattoli: la porta si apre e poi si chiude alle sue spalle, intrappolandola. I giocattoli prendono vita sotto il comando del Jack-in-the-Box, un pupazzo demoniaco creato a immagine di One-Eyed Jack, villain di AitD2, che tiene Babbo Natale prigioniero con l'intenzione di distruggere il Natale. Grace scopre da un libro nel negozio che solo una strega può sconfiggerlo: vestita da strega per Halloween, lo distrae con una caramella e gli punta uno specchio in faccia. Jack, inorridito dalla propria bruttezza riflessa, si rinchiude nella sua scatola. Le versioni CD-ROM di AitD1 e AitD2 includevano Jack in the Dark come bonus.",
    ...
    universes: [
      {
        ...
        entries: [
          ...
          { id: "origins", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "49 a.C. – 44 a.C.",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Assassin%27s%20Creed%20Origins.jpg",
            synopsis: {
      ...
      },
      {
        ...
        entries: [
          ...
          { id: "mirage", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "861",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Assassin%27s%20Creed%20Mirage.jpg",
            synopsis: {
          ...
          { id: "valhalla", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "872 – 878",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Assassin%27s%20Creed%20Valhalla.jpg",
            synopsis: {
      ...
      },
      {
        ...
        entries: [
          { id: "assassins-creed-1", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "1191",
            ...
            title: { it: "Assassin's Creed", en: "Assassin's Creed" },
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Assassin%27s%20Creed.jpg",
            synopsis: {
          ...
          { id: "ac-bloodlines", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "1191",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Assassin%27s%20Creed%20Bloodlines.jpg",
            synopsis: {
          ...
          { id: "lineage", type: "CORTOMETRAGGIO", typeEn: "SHORT FILM", year: "1476",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Assassin%27s%20Creed%20Lineage.jpg",
            synopsis: {
          ...
          { id: "embers", type: "CORTOMETRAGGIO", typeEn: "SHORT FILM", year: "1524",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Assassin%27s%20Creed%20Embers.jpg",
            synopsis: {
          ...
          { id: "chronicles-china", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "1526",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Assassin%27s%20Creed%20Chronicles%20China.jpg",
            synopsis: {
      ...
      },
      {
        ...
        entries: [
          ...
          { id: "freedom-cry", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "1735 – 1737",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Assassin%27s%20Creed%20Freedom%20Cry.jpg",
            synopsis: {
      ...
      },
      {
        ...
        entries: [
          { id: "assassins-creed-3", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "1754, 1775 – 1783",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Assassin%27s%20Creed%20III.jpg",
            synopsis: {
          ...
          { id: "syndicate", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "1868",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Assassin%27s%20Creed%20Syndicate.jpg",
            synopsis: {
      ...
      },
      {
        ...
        entries: [
          { id: "the-fall", type: "FUMETTO", typeEn: "COMIC", year: "1888 – 1917",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Assassin%27s%20Creed%20The%20Fall.jpg",
            synopsis: {
          ...
          { id: "chronicles-russia", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "1918",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Assassin%27s%20Creed%20Chronicles%20Russia.jpg",
            synopsis: {
          ...
          { id: "the-chain", type: "FUMETTO", typeEn: "COMIC", year: "1918 – 1920",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Assassin%27s%20Creed%20The%20Chain.jpg",
            synopsis: {
  ...
  bioshock: {
    id: "bioshock",
    listTitle: { it: "BioShock", en: "BioShock" },
    eyebrow: { it: "Fascicolo", en: "Case File" },
    ...
    universes: [
      {
        ...
        // frase "Per cortesia" gia' impiantata in Jack, innescando gli
        // eventi che aprono il primo BioShock) - va mostrato all'INIZIO
        // della linea di Rapture.
        universeLink: {
          edge: "start",
          direction: "from",
          targetUniverse: "columbia",
          label: { it: "Prosegue da Columbia", en: "Continues from Columbia" }
        },
        entries: [
      ...
      },
      {
        ...
        universeLink: {
          edge: "end",
          direction: "to",
          targetUniverse: "rapture",
          label: { it: "Prosegue su Rapture", en: "Continues on Rapture" }
        },
        entries: [
    ...
    universes: [
      {
        ...
        entries: [
          ...
          { id: "burning-of-lisa", type: "STORIA", typeEn: "STORY", year: "1094 – 1476", yearEn: "1094 – 1476",
            noAvatar: true,
            title: { it: "Il Rogo di Lisa", en: "The Burning of Lisa" },
            synopsis: {
              it: "Dopo la sconfitta di Walter, Leon Belmont rinuncia alla vendetta contro Mathias per dedicare la propria vita alla nascente stirpe di cacciatori dei Belmont. Nei secoli successivi Mathias, ormai divenuto immortale, vive isolato in apparente pace, finché non incontra e sposa la guaritrice umana Lisa, dalla quale ha un figlio, Adrian (Alucard). Nel 1470 l'Inquisizione condanna Lisa al rogo con l'accusa di stregoneria: la sua morte spezza l'ultimo legame di Mathias con l'umanità, spingendolo a dichiarare guerra al genere umano nel 1476 sotto il nome di Dracula.",
              en: "After Walter's defeat, Leon Belmont sets aside his revenge against Mathias to dedicate his life to the newborn lineage of Belmont hunters. Over the following centuries Mathias, now immortal, lives in isolation and apparent peace, until he meets and marries the human healer Lisa, with whom he has a son, Adrian (Alucard). In 1470 the Inquisition condemns Lisa to be burned at the stake on charges of witchcraft: her death severs Mathias's last tie to humanity, driving him to declare war on the human race in 1476 under the name of Dracula."
            }
          },
          ...
          { id: "curse-of-darkness-manga", type: "MANGA", typeEn: "MANGA", year: "Poco prima del 1479", yearEn: "Shortly before 1479",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Castlevania%20Akumaj%C5%8D%20Dracula%20Yami%20no%20Juin.jpg",
            synopsis: {
          ...
          { id: "belmonts-curse", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "1499",
            releaseYear: "2026", releaseYearEn: "2026",
            title: { it: "Castlevania: Belmont's Curse", en: "Castlevania: Belmont's Curse" },
            // Sinossi omessa di proposito: il gioco non è ancora uscito
            // (15 ottobre 2026), stesso trattamento già applicato ad Ace
            // Combat 8 (id "ace-8"). Tornare qui dopo l'uscita per sinossi
            // vera e immagine.
            imagePending: true,
            releaseDateShort: { it: "15 ottobre 2026", en: "October 15, 2026" },
            releaseDateISO: "2026-10-15"
          },
          { id: "the-adventure", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "1576",
            releaseYear: "1989 (Remaster: 2019, Remake: 2009)", releaseYearEn: "1989 (Remaster: 2019, Remake: 2009)",
          ...
          { id: "kabuchi-no-tsuisokyoku", type: "ROMANZO", typeEn: "NOVEL", year: "2037", yearEn: "2037",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Castlevania%20Akumaj%C5%8D%20Dracula%20Kabuchi%20no%20Tsuis%C5%8Dkyoku.jpg",
            synopsis: {
          ...
          { id: "grimoire-of-souls", type: "VIDEOGIOCO MOBILE", typeEn: "MOBILE VIDEOGAME", year: "Futuro indeterminato", yearEn: "Undetermined future",
            releaseYear: "2019 (2021 su Apple Arcade)", releaseYearEn: "2019 (2021 on Apple Arcade)",
            title: { it: "Castlevania: Grimoire of Souls", en: "Castlevania: Grimoire of Souls" },
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Castlevania%20Grimoire%20of%20Souls.jpg",
            synopsis: {
              it: "Genya Arikado (Alucard) riceve una lettera misteriosa poco dopo che il castello di Dracula è stato definitivamente sigillato nell'eclissi solare del 1999 e sembrava ormai giunta una pace duratura. La lettera lo mette sull'avviso e lo conduce a scoprire l'esistenza dei Grimoire, libri che custodiscono la memoria di tutti gli eventi della storia della saga: al loro interno, il castello e i nemici del passato tornano a manifestarsi, capaci perfino di richiamare in soccorso gli stessi eroi che un tempo li avevano affrontati. Messo in contatto da Lucy Westenra con Elgos, l'organizzazione fondata nel 1999 per custodire i beni sigillati di Dracula insieme ai Grimoire stessi, e affiancato dalla studiosa Hermina M. Lecarde, discendente del clan Lecarde, Arikado si addentra Grimoire dopo Grimoire, rivivendo e completando le imprese di Simon Belmont, di Jonathan Morris e Charlotte Aulin, di Richter Belmont e Maria Renard, per poi tornare sulla propria avventura contro Shaft, su quella di Shanoa contro l'Ordine di Ecclesia e infine su quella di Soma Cruz. È proprio in quest'ultimo Grimoire che si scopre la verità: il misterioso Seward, a capo di Elgos, altro non è che la Morte in persona, che si è infiltrata fisicamente nei Grimoire anziché limitarsi, come tutti gli altri nemici del passato, a esservi soltanto registrata. Smascherata, la Morte rivela di aver orchestrato l'intera vicenda per resuscitare Dracula, e nel Grimoire finale, che racchiude gli eventi di Dracula's Curse (1476), evoca repliche corrotte di Trevor Belmont, Grant Danasty e Sypha Belnades per confondere Arikado, sfruttando il ricordo della loro alleanza contro il Conte. Hermina, attingendo come discendente dei Lecarde alla Whip's Memory della Vampire Killer, riesce a evocare il vero Trevor Belmont, che si unisce ad Arikado nello scontro finale contro la Morte. Sconfitta la Morte e sigillata la Vital Soul, la minaccia viene neutralizzata senza alterare in alcun modo gli eventi già noti di Dracula's Curse: Trevor, Sypha, Grant e Alucard vincono comunque come da copione originale, e la vicenda si rivela un episodio aggiuntivo rimasto dietro le quinte, non una riscrittura di quanto già narrato. Nell'epilogo, Lucy Westenra riporta in vita Albus, riunendolo a Shanoa, mentre Arikado si congeda da lei e da Hermina.\n\nNota sulla chiusura del servizio: il gioco, gratuito con acquisti in-app, è stato ritirato dagli store nel 2020 e ripubblicato senza microtransazioni su Apple Arcade nel 2021; il servizio è stato definitivamente chiuso il 3 settembre 2026, ma la storia era già stata portata a una conclusione ufficiale con l'aggiornamento 1.4.0 del maggio 2022.",
              en: "Genya Arikado (Alucard) receives a mysterious letter shortly after Dracula's castle has finally been sealed within the solar eclipse of 1999, when a lasting peace seemed to have arrived at last. The letter puts him on alert and leads him to discover the existence of the Grimoires, books that hold the memory of every event in the saga's history: within their pages, the castle and the enemies of the past come back to life, even able to summon the very heroes who once fought them for help. Put in contact by Lucy Westenra with Elgos, the organisation founded in 1999 to guard Dracula's sealed possessions together with the Grimoires themselves, and joined by the scholar Hermina M. Lecarde, a descendant of the Lecarde clan, Arikado ventures Grimoire after Grimoire, reliving and completing the exploits of Simon Belmont, of Jonathan Morris and Charlotte Aulin, of Richter Belmont and Maria Renard, before returning to his own adventure against Shaft, to Shanoa's against the Order of Ecclesia, and finally to Soma Cruz's. It is within this last Grimoire that the truth comes out: the mysterious Seward, head of Elgos, is none other than Death himself, who has physically infiltrated the Grimoires rather than merely being recorded within them like every other enemy of the past. Unmasked, Death reveals he orchestrated the entire affair to resurrect Dracula, and within the final Grimoire, which holds the events of Dracula's Curse (1476), he conjures corrupted replicas of Trevor Belmont, Grant Danasty and Sypha Belnades to confuse Arikado, exploiting the memory of their alliance against the Count. Hermina, drawing as a Lecarde descendant on the Vampire Killer's Whip's Memory, manages to summon the true Trevor Belmont, who joins Arikado in the final battle against Death. With Death defeated and the Vital Soul sealed, the threat is neutralised without altering in any way the already-known events of Dracula's Curse: Trevor, Sypha, Grant and Alucard still win exactly as originally told, and the whole affair turns out to be an additional episode that unfolded behind the scenes, not a rewrite of what was already narrated. In the epilogue, Lucy Westenra brings Albus back to life, reuniting him with Shanoa, while Arikado bids farewell to her and to Hermina.\n\nNote — service closure: the game, free-to-play with in-app purchases, was pulled from app stores in 2020 and relaunched without microtransactions on Apple Arcade in 2021; the service was permanently shut down on September 3, 2026, but the story had already reached an official conclusion with the 1.4.0 update in May 2022."
            }
          }
        ]
      },
      {
        ...
        entries: [
          { id: "castlevania-64", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "1852",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Castlevania%2064.jpg",
            synopsis: {
              it: "Otto anni dopo gli eventi di Legacy of Darkness, nel 1852, Dracula si risveglia dopo quasi sessant'anni di sigillo forzato, conseguenza della crescente corruzione del genere umano. Ad accorgersene per primi sono Reinhardt Schneider, erede di un ramo cadetto del clan Belmont e detentore della Vampire Killer, e Carrie Fernandez, giovane discendente del clan Belnades dotata di poteri magici: i due si dirigono verso il castello del Conte in Transilvania per fermarlo, incrociando lungo il cammino il vecchio cacciatore Charles Vincent, la vampira riluttante Rosa, il mercante demoniaco Renon e uno strano bambino di nome Malus, che sostiene di essere stato rapito da un villaggio vicino. Sotto il giardino del labirinto del castello, i servitori di Dracula Actrise e la Morte cercano di fermare l'eroe di turno costringendolo a scontrarsi con propri cari trasformati in vampiri, per poi affrontarlo di nuovo sulla sommità della Room of Clocks. Qui la Morte tenta di colpire a tradimento l'eroe, ma Rosa si frappone sacrificandosi al suo posto. Raggiunto il vertice del castello, l'eroe scopre che Malus non era posseduto, come sembrava, ma era Dracula stesso, reincarnato fin dalla nascita in un nuovo corpo: ne affronta prima la forma adulta e poi quella genuina del Conte, sconfiggendolo. Il gioco offre due percorsi giocabili in parallelo, quello di Reinhardt e quello di Carrie, con boss e aree in parte differenti; ciascuno dei due dispone di un finale positivo, ottenuto completando l'avventura entro un tempo di gioco limitato che permette a Charles Vincent di raggiungere il castello in tempo per rivelare la vera identità di Malus, e di un finale negativo se il giocatore impiega troppo a lungo. Nel finale positivo di Reinhardt, Rosa viene riportata in vita e liberata dalla propria maledizione; in quello di Carrie, la ragazza rende omaggio alla tomba della propria matrigna.",
    ...
    universes: [
      {
        ...
        entries: [
          ...
          { id: "dmc4", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "5 anni dopo DMC2", yearEn: "5 years after DMC2", releaseYear: "2008 (Remaster: 2015)", releaseYearEn: "2008 (Remaster: 2015)",
      ...
      },
      {
        ...
        entries: [
          { id: "chronicles-of-vergil", type: "FUMETTO", typeEn: "COMIC", year: "Un anno prima di DmC", yearEn: "One year before DmC", releaseYear: "2013", releaseYearEn: "2013",
            ...
            image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Devil%20May%20Cry%20The%20Chronicles%20of%20Vergil.jpg",
            synopsis: {
...
,
  ...
  doom: {
    ...
    canonNote: {
      intro: {
        it: "A differenza degli altri franchise di questo archivio, Doom non ha mai avuto una vera linea temporale ufficiale, confermata pubblicamente dagli sviluppatori. Il motivo affonda le radici già nei giochi originali del 1993-1994, usciti praticamente senza una trama vera e propria: la storia era solo un pretesto per far correre un marine anonimo, ribattezzato dai fan \"Doomguy\", attraverso basi su Marte invase dai demoni, fino a scoprire che l'Inferno stesso si è riversato sulla Terra. Quello che oggi viene chiamato \"canon\" è stato ricostruito nel tempo, per lo più dai fan, e solo in parte confermato da dichiarazioni vaghe di id Software, che non ha mai chiarito con certezza se il Doom classico e il Doom moderno condividano la stessa Terra o siano due mondi paralleli invasi dallo stesso Inferno: nel libro illustrato ufficiale The Art of Doom Eternal, gli stessi sviluppatori hanno persino provato a spiegare questa ambiguità proponendo l'idea di due Terre parallele, senza però che diventasse mai un piano narrativo dichiarato con certezza. Anche quando si sono espressi direttamente, gli sviluppatori si sono contraddetti nel tempo: il direttore creativo dei capitoli più recenti ha detto, in momenti diversi, cose opposte su quali giochi debbano considerarsi canonici. E non tutto ciò che porta il nome Doom viene trattato allo stesso modo nemmeno da loro: nel 2019 hanno preso pubblicamente le distanze dal film Doom: Annihilation, dopo aver rifiutato di prendere parte alla sua realizzazione. Nei capitoli più recenti, lo stesso marine, ormai il Doom Slayer, diventa comunque una leggenda quasi divina: un guerriero forgiato in un'altra dimensione, capace di sfidare gli dei dell'Inferno e persino il creatore di ogni cosa.",
        en: "Unlike the other franchises in this archive, Doom has never had a real official timeline, publicly confirmed by its developers. The reason goes back to the original games of 1993-1994, which came out with almost no real story: the plot was just an excuse to send an anonymous marine, later nicknamed \"Doomguy\" by fans, running through demon-infested bases on Mars, only to discover that Hell itself had spilled onto Earth. What is called \"canon\" today was pieced together over time, mostly by fans, and only partly confirmed through vague statements from id Software, which has never made clear whether classic Doom and modern Doom share the same Earth or are parallel worlds invaded by the same Hell — in fact, in the official art book The Art of Doom Eternal, the developers themselves even tried to explain that ambiguity by proposing the idea of two parallel Earths, though it never became a firmly declared narrative plan. Even when they have spoken directly about it, the developers have contradicted themselves over time: the creative director of the more recent chapters has said opposite things, at different times, about which games should be considered canon. And not everything carrying the Doom name is treated the same way even by them: in 2019 they publicly distanced themselves from the film Doom: Annihilation, after declining to take part in making it. In the more recent chapters, that same marine, now the Doom Slayer, still becomes an almost divine legend: a warrior forged in another dimension, capable of challenging the gods of Hell and even the creator of everything."
      },
      chain: [
        { id: "doom1993", title: { it: "Doom (1993)", en: "Doom (1993)" },
          image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Doom.jpg" },
        { id: "doom2", title: { it: "Doom II: Hell on Earth", en: "Doom II: Hell on Earth" },
          image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Doom%202.jpg" },
        { id: "finaldoom", title: { it: "Final Doom", en: "Final Doom" },
          image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Final%20Doom.jpg" },
        { id: "doom64", title: { it: "Doom 64", en: "Doom 64" },
          image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Doom%2064.jpg" },
        { id: "darkages", title: { it: "Doom: The Dark Ages", en: "Doom: The Dark Ages" },
          image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Doom%20The%20Dark%20Ages.jpg" },
        { id: "revelations", title: { it: "Doom: The Dark Ages – Revelations", en: "Doom: The Dark Ages – Revelations" },
          image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Doom%20The%20Dark%20Ages%20Revelations.jpg" },
        { id: "doom2016", title: { it: "Doom (2016)", en: "Doom (2016)" },
          image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Doom%20%282016%29.jpg" },
        { id: "doomvfr", title: { it: "Doom VFR", en: "Doom VFR" },
          image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Doom%20VFR.jpg" },
        { id: "eternal", title: { it: "Doom Eternal", en: "Doom Eternal" },
          image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Doom%20Eternal.jpg" },
        { id: "ancientgods", title: { it: "Doom Eternal: The Ancient Gods", en: "Doom Eternal: The Ancient Gods" },
          image: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Doom%20Eternal%20The%20Ancient%20gods.jpg" }
      ],
      outro: {
        it: "Nonostante l'assenza di una linea ufficiale, i fan hanno comunque provato a mettere in ordine i giochi elencati sopra, usando piccoli indizi sparsi nei testi e nei filmati dei capitoli più recenti: indizi aggiunti nel tempo, non un piano scritto fin dall'inizio. L'esempio più chiaro si trova nel finale di The Lost Levels, un episodio bonus aggiunto nel 2020 alla riedizione di Doom 64 (uscita proprio il giorno del lancio di Doom Eternal): quel finale nomina le Slayer's Testaments, un elemento della trama di Doom (2016), come per suggerire che le due storie si tocchino davvero. Anche il vecchio spin-off per cellulari Doom RPG (2005) va nella stessa direzione: la sua pubblicità descriveva l'eroe del gioco come lo stesso soldato di Doom, Doom II e Doom 3. Le due espansioni narrative più recenti, The Ancient Gods (2021, per Doom Eternal) e Revelations (2026, per Doom: The Dark Ages), restano nello stesso terreno incerto: quest'ultima si chiude citando il nome \"Flynn Taggart\", quello dato al marine protagonista nei romanzi Doom degli anni '90, un piccolo omaggio che sembra voler collegare le due epoche senza mai dirlo apertamente.\n\nDoom 3, uscito nel 2004, resta invece un caso a parte irrisolto: presentato all'epoca più come un survival horror a sé stante che come un capitolo action in linea con gli altri, non è mai stato collocato con certezza né tra i giochi classici né tra quelli moderni. Anche i due titoli legati a Doom 3, l'espansione Resurrection of Evil (2005) e la campagna bonus The Lost Mission (2012), condividono la stessa ambientazione ma non un protagonista dichiarato con certezza come la stessa persona, e l'ordine in cui si susseguono resta un'ipotesi dei giocatori, non qualcosa di scritto dagli sviluppatori.",
        en: "Despite the lack of an official timeline, fans have still tried to put the games listed above in order, using small clues scattered through the text and cutscenes of the more recent entries — clues added over time, not part of a plan laid out from the start. The clearest example is the ending of The Lost Levels, a bonus episode added in 2020 to the Doom 64 re-release (which launched on the very same day as Doom Eternal): that ending names the Slayer's Testaments, a plot element from Doom (2016), as if suggesting the two stories genuinely connect. The old mobile spin-off Doom RPG (2005) points the same way: its advertising described the game's hero as the same soldier from Doom, Doom II, and Doom 3. The two most recent narrative expansions, The Ancient Gods (2021, for Doom Eternal) and Revelations (2026, for Doom: The Dark Ages), stay in that same uncertain territory: the latter closes by naming \"Flynn Taggart\", the name given to the marine hero in the Doom novels of the 1990s, a small nod that seems to want to connect the two eras without ever openly saying so.\n\nDoom 3, released in 2004, remains a case apart that was never resolved: presented at the time more as a standalone survival horror game than as an action chapter in line with the others, it has never been placed with certainty in either the classic or the modern continuity. Even the two titles tied to Doom 3, the expansion Resurrection of Evil (2005) and the bonus campaign The Lost Mission (2012), share the same setting but not a protagonist confirmed with certainty as the same person, and the order in which they follow one another remains a fan guess, not something the developers ever wrote down."
      }
    }
  },
  "dragon-quest": {
    ...
    universes: [
      {
        ...
        entries: [
          ...
          { id: "dq1", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "Secoli dopo Erdrick", yearEn: "Centuries after Erdrick", releaseYear: "1986 (Remake: 2025)", releaseYearEn: "1986 (Remake: 2025)",
            title: { it: "Dragon Quest", en: "Dragon Quest" },
          ...
          { id: "dq2", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "Un secolo dopo Dragon Quest", yearEn: "A century after Dragon Quest", releaseYear: "1987 (Remake: 2025)", releaseYearEn: "1987 (Remake: 2025)",
            title: { it: "Dragon Quest II", en: "Dragon Quest II: Luminaries of the Legendary Line" },
    ...
    universes: [
      {
        ...
        span: { it: "2077 – 2296", en: "2077 – 2296" },
        watermark: "https://pub-de8310383cdb437f8f0b585a6642e88e.r2.dev/Fallout%20Filigrana.jpg",
        // Palette a sottogruppi narrativi (fase Artista, 06/09,
        // Opzione 2 "Manifesto del Pericolo" scelta da Sakrem): A -
        // Genesi della Cenere (One Man and a Crate of Puppets, Fallout
        // 76), B - La Stirpe dei Vault e l'Ombra del Purismo (Fallout,
        // Fallout 2, Fallout 3; accento), C - Le Strade del Mojave (All
        // Roads, New Vegas), D - L'Eredita' del Sopravvissuto e la
        // Cospirazione dell'Enclave (Fallout 4, serie TV), E -
        // L'Overseer e la Vault-Tec (Fallout Shelter). paletteBounds:
        // ultima voce reale dei primi 4 sottogruppi su 5 (il quinto,
        // Fallout Shelter, arriva naturalmente fino alla fine
        // dell'universo).
        palette: ["#201D18", "#2FE86A", "#C1541E", "#7A1F2E", "#E8B93F"],
        paletteBounds: ["fallout-76", "fallout-3", "new-vegas", "fallout-tv"],
        entries: [
          { id: "one-man-crate-of-puppets", type: "FUMETTO", typeEn: "COMIC", year: "2077 – 2079", yearEn: "2077 – 2079", releaseYear: "2008", releaseYearEn: "2008",
            title: { it: "One Man, and a Crate of Puppets", en: "One Man, and a Crate of Puppets" },
            synopsis: {
              it: "Webcomic ufficiale scritto da Jerry Holkins (in arte Tycho Brahe) e disegnato da Mike Krahulik (in arte Gabe), i creatori di Penny Arcade, realizzato in collaborazione con Emil Pagliarulo, lead designer di Fallout 3, e pubblicato a puntate settimanali sul sito ufficiale del gioco a partire dal luglio 2008. Racconta la storia di Vault 77, un rifugio sperimentale di Vault-Tec pensato per un solo occupante e una cassa di marionette a mano, concepito per studiare la tenuta psicologica di un individuo in isolamento pressoché totale.\n\nIl Vault viene sigillato il 23 ottobre 2077, giorno stesso della Grande Guerra, con un solo abitante, che dapprima crede si tratti di un errore e implora inutilmente che vengano ammessi altri occupanti. Gli anni di solitudine ne logorano progressivamente la salute mentale: il 4 febbraio 2079 apre la cassa etichettata \"P13X U.S. GOVERNMENT ISSUE PUPPET RATION\" e comincia a intrattenersi con le marionette al suo interno, perdendosi sempre più nei giochi di ruolo che inventa con loro. Il 30 marzo 2079 sviluppa un disturbo dissociativo, convincendosi che la marionetta a forma di Vault Boy gli parli davvero: quella notte fa a pezzi la marionetta-re, per poi accusare proprio il Vault Boy dell'omicidio.\n\nApre infine la porta del Vault e si trova davanti a uno scorpione radioattivo delle dimensioni di un Boeing 747; richiude tutto e \"ci dorme sopra\" prima di riuscire, in un secondo tentativo, a lasciare il rifugio in sella a una formica gigante che battezza Mr. Pinch. Catturato da un gruppo di schiavisti indecisi se renderlo schiavo o mangiarlo, li avverte inutilmente che la sua marionetta è \"pazza\" e \"ha già ucciso\". Quella notte uno degli schiavisti fugge terrorizzato verso un altro accampamento gridando che la marionetta ha ucciso il suo compagno e sta arrivando anche per loro: l'ultima vignetta lo mostra, marionetta in mano, in piedi tra i cadaveri di tutti gli schiavisti, coperto di sangue. Il fumetto del 2008 lascia così volutamente ambigua la sua sorte definitiva.\n\nIl collegamento con Fallout 3 (2277) è diretto: nella Baracca degli Schiavisti di Paradise Falls si trovano la sua tuta del Vault 77 e un holotape intitolato \"Burn this goddamn jumpsuit\", in cui uno schiavista chiede che l'indumento venga bruciato per timore che il suo proprietario possa tornare a cercare vendetta.\n\nNota: nell'aprile 2024 Penny Arcade ha pubblicato un seguito di tre vignette, \"The Right Hand of the King\", che mostra il Puppet Man sopravvissuto e diventato un signore della guerra a capo di una fortezza che controlla l'accesso all'acqua nella zona. Il seguito risolve così, sedici anni dopo, quello che nel fumetto originale era rimasto un finale volutamente ambiguo.",
              en: "Official webcomic written by Jerry Holkins (a.k.a. Tycho Brahe) and drawn by Mike Krahulik (a.k.a. Gabe), the creators of Penny Arcade, made in collaboration with Emil Pagliarulo, lead designer of Fallout 3, and published in weekly instalments on the game's official website starting in July 2008. It tells the story of Vault 77, an experimental Vault-Tec shelter designed for a single occupant and a crate of hand puppets, meant to study the psychological resilience of an individual in near-total isolation.\n\nThe Vault is sealed on October 23, 2077, the very day of the Great War, with a single inhabitant, who at first believes it to be a mistake and pleads in vain for other occupants to be let in. Years of solitude gradually erode his sanity: on February 4, 2079 he opens the crate labelled \"P13X U.S. GOVERNMENT ISSUE PUPPET RATION\" and begins entertaining himself with the puppets inside, increasingly losing himself in the role-plays he invents with them. On March 30, 2079 he develops a dissociative disorder, convincing himself that the Vault Boy puppet is really talking to him: that night he tears apart the king puppet, then accuses the Vault Boy puppet itself of the murder.\n\nHe finally opens the Vault door and finds himself facing a radscorpion the size of a Boeing 747; he seals it shut again and \"sleeps on it\" before managing, on a second attempt, to leave the shelter riding a giant ant he names Mr. Pinch. Captured by a group of slavers debating whether to enslave or eat him, he warns them in vain that his puppet is \"crazy\" and has \"killed before.\" That night one of the slavers flees in terror to another camp, screaming that the puppet has killed his partner and is coming for them too — the final panel shows him, puppet in hand, standing among the corpses of all the slavers, covered in blood. The 2008 comic deliberately leaves his ultimate fate ambiguous.\n\nThe connection to Fallout 3 (2277) is direct: in the Slaver Barracks at Paradise Falls, his Vault 77 jumpsuit and a holotape titled \"Burn this goddamn jumpsuit\" can be found, in which a slaver asks for the garment to be burned for fear its former owner might return seeking revenge.\n\nNote: in April 2024, Penny Arcade published a three-panel sequel, \"The Right Hand of the King,\" showing the Puppet Man alive and now a warlord ruling a fortress that controls the area's water access — resolving, sixteen years later, what had been a deliberately ambiguous ending in the original comic."
            }
          },
          { id: "fallout-76", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "2102", releaseYear: "2018", releaseYearEn: "2018",
            ...
            synopsis: {
              it: "Venticinque anni dopo la Grande Guerra, i primi abitanti del Vault 76 emergono in Virginia Occidentale nel Giorno della Riconquista (23 ottobre 2102) con l'incarico di ricostruire l'America. Seguendo la pista di registrazioni lasciate dal Sorvegliante del Vault, scoprono che gli Ardenti, una piaga radioattiva che trasforma le persone in creature simili a zombie guidate da una mente alveare, sono in realtà un'arma biologica: Thomas Eckhart, dirigente dell'Enclave, ha rilasciato gli Scorchbeast per eliminare la concorrenza del governo regionale DEFCON. Con l'aiuto dell'intelligenza artificiale MODUS dell'Enclave, i sopravvissuti si organizzano per colpire con un attacco nucleare i covi degli Scorchbeast. Capitolo ambientato nel periodo cronologicamente più risalente fra i videogiochi principali della saga, e unico interamente online, privo in origine di qualunque personaggio umano non giocante.\n\nNota: gli aggiornamenti Wastelanders, Steel Dawn e Steel Reign (2020-2021) trasformano radicalmente l'Appalachia, introducendo per la prima volta abitanti umani non giocanti. Nel 2103 i Raiders, tornati a reclamare le proprie terre nella base di Crater, e i Settlers, coloni radunatisi a Foundation, si contendono un tesoro leggendario, costringendo il giocatore a schierarsi con l'una o l'altra fazione. Poco dopo, la Confraternita d'Acciaio invia in Appalachia la propria Prima Forza di Spedizione, guidata dalla paladina Leila Rahmani, per rintracciare la cellula locale della paladina Elizabeth Taggerdy: lo scontro tra la linea più politica di Rahmani e quella intransigente del cavaliere Shin culmina, dopo l'attacco dei super mutanti a Fort Atlas, in una resa dei conti sul destino di un gruppo di scienziati coinvolti in un esperimento di diffusione del F.E.V., chiudendo la trama della Confraternita nella regione.",
              en: "Twenty-five years after the Great War, the first inhabitants of Vault 76 emerge in West Virginia on Reclamation Day (October 23, 2102) tasked with rebuilding America. Following a trail of recordings left by the Vault's Overseer, they discover that the Scorched, a radioactive plague that turns people into zombie-like creatures controlled by a hive mind, are actually a bioweapon: Thomas Eckhart, an Enclave official, released the Scorchbeasts to eliminate the competing regional government DEFCON. With the help of the Enclave AI MODUS, the survivors organise a nuclear strike against the Scorchbeasts' nests. The chronologically earliest chapter among the saga's main video games, and the only one entirely online, originally devoid of any human non-player characters.\n\nNote: the Wastelanders, Steel Dawn, and Steel Reign updates (2020-2021) radically transform Appalachia, introducing human NPCs for the first time. In 2103 the Raiders, returned to reclaim their land at the Crater base, and the Settlers, colonists gathered at Foundation, both vie for a legendary treasure, forcing the player to side with one faction or the other. Shortly after, the Brotherhood of Steel sends its First Expeditionary Force to Appalachia, led by Paladin Leila Rahmani, to track down the local cell led by Paladin Elizabeth Taggerdy: the clash between Rahmani's more political approach and Knight Shin's hardline stance culminates, after the super mutant attack on Fort Atlas, in a reckoning over the fate of a group of scientists involved in a F.E.V. dispersal experiment, closing out the Brotherhood's storyline in the region."
            }
          },
          { id: "fallout-1", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "2161", releaseYear: "1997", releaseYearEn: "1997",
            title: { it: "Fallout", en: "Fallout" },
            synopsis: {
              it: "Il Vault 13, in California, rischia di esaurire il water chip che ne garantisce la sopravvivenza. Il Vault Dweller viene inviato in superficie a recuperarne uno sostitutivo, scoprendo lungo il cammino il piano del Master, un essere mutante che vuole assimilare l'intera umanità superstite in un unico organismo collettivo. Il gioco capostipite dell'intera saga.",
          ...
          { id: "fallout-2", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "2241", releaseYear: "1998", releaseYearEn: "1998",
            ...
            synopsis: {
              it: "Ottant'anni dopo il primo gioco, il Chosen One parte dal villaggio di Arroyo, fondato dai discendenti del primo Vault Dweller, alla ricerca di un G.E.C.K. (Garden of Eden Creation Kit), un dispositivo capace di rendere di nuovo fertile la terra. Lungo il viaggio scopre i piani dell'Enclave, resti del governo pre-guerra intenzionati a sterminare ogni forma di vita mutata per ripopolare l'America con i soli «puri».",
          ...
          { id: "fallout-3", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "2277", releaseYear: "2008", releaseYearEn: "2008",
            ...
            synopsis: {
              it: "Nato e cresciuto nel Vault 101 a Washington D.C., il Vagabondo Solitario ne esce sulle tracce del padre, scomparso misteriosamente, scoprendo il suo coinvolgimento nel Progetto Purezza, un tentativo di depurare l'acqua radioattiva del Fiume Potomac, conteso dall'Enclave che intende usarlo per sterminare i mutanti invece che curarli.",
          ...
          { id: "all-roads", type: "FUMETTO", typeEn: "COMIC", year: "2281", yearEn: "2281", releaseYear: "2010 (digitale: 2011)", releaseYearEn: "2010 (digital: 2011)",
            title: { it: "All Roads", en: "All Roads" },
            synopsis: {
              it: "Graphic novel scritta da Chris Avellone (già lead designer di Fallout: New Vegas) e disegnata da Jean Diaz e Wellington Alves, pubblicata da Dark Horse Comics nel 2010 come contenuto bonus della Collector's Edition di New Vegas (e resa disponibile in digitale nel 2011). Racconta gli eventi della settimana immediatamente precedente all'inizio del videogioco dal punto di vista di Benny, capo dei Chairmen, i gestori del casinò The Tops sulla Strip di New Vegas.\n\nBenny, ex capo della tribù nomade dei Mojave Boot-Riders (di cui i Chairmen sono la versione \"rispettabile\" voluta da Mr. House dopo la sottomissione della tribù), è ossessionato dal cancellare ogni traccia del proprio passato: quando il Singer, un anziano Chairman che con le sue canzoni rievoca i tempi dei Boot-Riders, comincia a raccogliere consensi per un ritorno alla vita tribale, Benny lo fa uccidere con un'overdose di Psycho. Nel frattempo, grazie alla scienziata dei Followers of the Apocalypse Emily Ortal, che gli permette di riprogrammare il securitron Yes Man e accedere alla rete dati di Mr. House, Benny scopre che un Corriere sta per consegnare un misterioso chip di platino e organizza un'imboscata per intercettarlo e rubarglielo, nella speranza di scoprire come usarlo per estromettere House e prendere il controllo della città.\n\nPer l'agguato assolda un gruppo di mercenari Great Khan, tra cui Chance, un gigante muto, tossicodipendente e segnato dal trauma del massacro di Bitter Springs, incapace di lasciarsi il passato alle spalle: uno specchio rovesciato dello stesso Benny. Durante il viaggio verso Goodsprings, Benny offre a Chance la stessa dose di Psycho usata per uccidere il Singer, lasciandogli intendere che è tempo di scegliere se riprendersi o farla finita: Chance sceglie di morire, e viene sepolto, contro la volontà di Benny, dagli altri Khan Jessup e McMurphy nel cimitero di Goodsprings.\n\nLa storia si chiude con l'imboscata vera e propria: Benny e i suoi uomini intercettano il Corriere a Goodsprings, gli sparano rubandogli il chip di platino e lo seppelliscono in una fossa poco profonda per coprire le tracce, l'evento con cui si apre Fallout: New Vegas. Il securitron Victor, in segreto ancora fedele a Mr. House, dissotterrerà il Corriere sopravvissuto, affidandolo alle cure del dottor Mitchell a Goodsprings.",
              en: "Graphic novel written by Chris Avellone (former lead designer of Fallout: New Vegas) and drawn by Jean Diaz and Wellington Alves, published by Dark Horse Comics in 2010 as bonus content in New Vegas's Collector's Edition (and made available digitally in 2011). It tells the events of the week immediately preceding the start of the video game from the point of view of Benny, head of the Chairmen, who run The Tops casino on the New Vegas Strip.\n\nBenny, former chief of the nomadic Mojave Boot-Riders tribe (of which the Chairmen are the \"respectable\" makeover imposed by Mr. House after the tribe's submission), is obsessed with erasing every trace of his past: when the Singer, an elderly Chairman whose songs stir up nostalgia for the Boot-Rider days, starts gathering support for a return to tribal life, Benny has him killed with an overdose of Psycho. Meanwhile, with the help of Followers of the Apocalypse scientist Emily Ortal, who lets him reprogram the securitron Yes Man and access Mr. House's data network, Benny learns that a Courier is about to deliver a mysterious platinum chip, and sets up an ambush to intercept and steal it, hoping to find a way to use it to oust House and seize control of the city.\n\nFor the ambush he hires a group of Great Khan mercenaries, among them Chance, a mute giant, drug addict, and scarred by the trauma of the Bitter Springs massacre, unable to let go of the past — a mirror image of Benny himself. On the journey to Goodsprings, Benny offers Chance the same dose of Psycho used to kill the Singer, implying it's time for him to choose between getting better or ending it: Chance chooses to die, and is buried, against Benny's wishes, by fellow Khans Jessup and McMurphy in the Goodsprings cemetery.\n\nThe story closes with the ambush itself: Benny and his men intercept the Courier at Goodsprings, shoot them and steal the platinum chip, then bury them in a shallow grave to cover their tracks — the event that opens Fallout: New Vegas. The securitron Victor, secretly still loyal to Mr. House, will dig the surviving Courier back out, delivering them into the care of Doc Mitchell in Goodsprings."
            }
          },
          { id: "new-vegas", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "2281", releaseYear: "2010", releaseYearEn: "2010",
            ...
            synopsis: {
              it: "Il Corriere, lasciato per morto dopo essere stato derubato di un misterioso pacchetto (un chip di platino), sopravvive e insegue il proprio aggressore fino a New Vegas, scoprendo di trovarsi al centro di una contesa tra la Legione di Caesar, la Repubblica della Nuova California e il misterioso Mr. House per il controllo della Diga di Hoover e dell'intera regione.",
          ...
          { id: "fallout-4", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "2287", releaseYear: "2015 (Remaster: 2024)", releaseYearEn: "2015 (Remaster: 2024)",
            title: { it: "Fallout 4", en: "Fallout 4" },
            synopsis: {
              it: "Il Sopravvissuto Unico, criogenizzato nel Vault 111 poco prima della Grande Guerra, si risveglia decenni dopo avendo assistito all'omicidio del coniuge e al rapimento del proprio figlio neonato. La ricerca del bambino, ormai adulto e a capo dell'Istituto (un'organizzazione segreta che crea sintetici umanoidi), lo porta al centro di un conflitto tra fazioni sul futuro stesso del Commonwealth del Massachusetts.\n\nNota: il Remaster 2024 (Next-Gen Update) introduce per la prima volta l'Enclave nel Commonwealth tramite la missione Echoes of the Past, in cui il Sopravvissuto Unico scopre che i resti dell'organizzazione hanno sterminato una carovana e li rintraccia fino al loro quartier generale sul campo, sconfiggendone il comandante prima che possano stabilire una base nella regione.",
              en: "The Sole Survivor, cryogenically frozen in Vault 111 shortly before the Great War, awakens decades later having witnessed their spouse's murder and their infant son's kidnapping. The search for the child, now an adult and head of the Institute (a secretive organisation that creates synthetic humanoids), draws them into a factional conflict over the very future of the Commonwealth of Massachusetts.\n\nNote — 2024 Remaster (Next-Gen Update): introduces the Enclave into the Commonwealth for the first time through the quest Echoes of the Past, in which the Sole Survivor discovers that the organisation's remnants wiped out a caravan and tracks them to their field headquarters, defeating their commanding officer before they can establish a base in the region."
            }
          },
          { id: "fallout-tv", type: "SERIE TV", typeEn: "TV SERIES", year: "2296", releaseYear: "2024 – in corso", releaseYearEn: "2024 – ongoing",
            title: { it: "Fallout", en: "Fallout" },
            synopsis: {
              it: "Nel 2296, nove anni dopo gli eventi di Fallout 4, Lucy MacLean lascia il Vault 33 per salvare suo padre Hank, rapito dalla predona Lee Moldaver. Il suo cammino si intreccia con quello di Maximus, aspirante Cavaliere della Confraternita d'Acciaio, e con quello del Ghoul, al secolo l'attore Cooper Howard, mutato dalle radiazioni durante la Grande Guerra del 2077 e sulle tracce della propria famiglia. Nel finale della prima stagione si scopre che Hank, ex dirigente Vault-Tec risvegliato dal crio-sonno nel dopoguerra, è il responsabile della distruzione della città di Shady Sands (dove la moglie Rose si era rifugiata con i figli dopo aver scoperto la verità sui vault), avvenuta poco dopo gli eventi di Fallout: New Vegas; Lucy pone fine alla sofferenza della madre, ormai ridotta a ghoul feroce, mentre Hank fugge in armatura energetica verso Las Vegas.\n\nNella seconda stagione Lucy e il Ghoul inseguono Hank fino alla Mojave Wasteland e a New Vegas, dove riemerge Mr. House, ancora al comando del Lucky 38. Il Ghoul scopre che dietro l'intera catastrofe nucleare si cela l'Enclave, un'organizzazione ben più antica e potente della sola Vault-Tec, di cui lo stesso Hank è un membro. Nel finale, con Hank ridotto a un guscio senza memoria dal proprio dispositivo di controllo mentale e il diodo a fusione fredda tornato nelle mani di Mr. House, i resti della Legione di Caesar marciano su New Vegas: la serie evita deliberatamente di rendere canonico uno specifico finale del videogioco New Vegas, lasciando presagire lo scontro tra Legione e RNC all'inizio della terza stagione, già confermata. Dichiarata da Todd Howard e Bethesda parte integrante della continuità della saga.",
              en: "In 2296, nine years after the events of Fallout 4, Lucy MacLean leaves Vault 33 to save her father Hank, kidnapped by the raider Lee Moldaver. Her path crosses with Maximus, an aspiring Knight of the Brotherhood of Steel, and with the Ghoul, formerly the actor Cooper Howard, mutated by radiation during the Great War of 2077 and searching for his own family. In the first season finale it's revealed that Hank, a former Vault-Tec executive awoken from cryo-sleep after the war, is responsible for the destruction of the city of Shady Sands (where his wife Rose had taken refuge with their children after learning the truth about the vaults), which occurred shortly after the events of Fallout: New Vegas; Lucy ends her mother's suffering, by then reduced to a feral ghoul, while Hank flees toward Las Vegas in power armor.\n\nIn the second season, Lucy and the Ghoul chase Hank into the Mojave Wasteland and New Vegas, where Mr. House resurfaces, still in command of the Lucky 38. The Ghoul discovers that behind the entire nuclear catastrophe lies the Enclave, an organisation far older and more powerful than Vault-Tec alone, of which Hank himself is a member. In the finale, with Hank reduced to a memoryless husk by his own mind-control device and the cold fusion diode back in Mr. House's hands, the remnants of Caesar's Legion march on New Vegas: the show deliberately avoids canonising any specific ending of the New Vegas video game, hinting at a coming clash between the Legion and the NCR at the start of the already-confirmed third season. Declared by Todd Howard and Bethesda to be an integral part of the saga's continuity."
            }
          },
          { id: "fallout-shelter", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "Epoca della serie TV, 2296 e oltre", yearEn: "The TV series era, 2296 and beyond", releaseYear: "2015 (contenuti qui trattati: 2024 – 2026)", releaseYearEn: "2015 (content covered here: 2024–2026)",
            title: { it: "Fallout Shelter", en: "Fallout Shelter" },
            synopsis: {
              it: "Videogioco mobile di simulazione gestionale sviluppato da Bethesda Game Studios, pubblicato nel 2015 (e in seguito anche su PC e console), in cui il giocatore veste i panni del Sorvegliante di un Vault, reclutandone gli abitanti, costruendone le stanze e proteggendoli da incidenti, incursioni e mostri della zona contaminata.\n\nNell'aprile 2024, in concomitanza con la première della serie TV, l'aggiornamento A Pier into the Future avvia la linea di missioni Power Struggle, che rende reclutabili come abitanti leggendari Lucy MacLean, il Ghoul e Maximus, i tre protagonisti della serie. Nella missione My Brothers' Keeper, ambientata in una base della Confraternita d'Acciaio, gli abitanti incontrano paladini e uno scriba, affrontano un artiglio della morte fuggito e infine trovano Maximus, che chiede di custodire un segreto prima di unirsi al Vault del giocatore.\n\nA partire dal dicembre 2025 il gioco introduce il sistema delle Stagioni, Vault sperimentali a tempo limitato con ambientazioni e trame proprie. La prima, Viva New Vegas (12 dicembre 2025 – 18 gennaio 2026), è pensata esplicitamente come \"antipasto\" della seconda stagione della serie TV: un Vault sperimentale sepolto nel deserto nei pressi di Novac, nel Mojave, dove il giocatore deve radunare alleati e riportare Novac sotto controllo trasformandola in un avamposto sotto le luci di New Vegas, di nuovo al fianco di Lucy, Maximus e il Ghoul. Le succede House Always Wins (21 gennaio – 28 febbraio 2026), che prosegue la stessa linea narrativa nello stesso Vault sperimentale, introducendo tra le ricompense stagionali anche Victor, il securitron di Mr. House.",
              en: "Mobile management simulation game developed by Bethesda Game Studios, released in 2015 (and later also on PC and consoles), in which the player takes on the role of a Vault's Overseer, recruiting its dwellers, building its rooms, and protecting them from incidents, raids, and monsters from the wasteland.\n\nIn April 2024, timed with the TV series premiere, the A Pier into the Future update launched the Power Struggle quest line, making Lucy MacLean, the Ghoul, and Maximus — the show's three protagonists — recruitable as Legendary dwellers. In the quest My Brothers' Keeper, set in a Brotherhood of Steel base, the dwellers meet paladins and a scribe, face an escaped deathclaw, and finally find Maximus, who asks them to keep a secret before joining the player's Vault.\n\nStarting in December 2025 the game introduced Seasons, time-limited experimental Vaults with their own settings and storylines. The first, Viva New Vegas (December 12, 2025 – January 18, 2026), is explicitly conceived as a \"teaser\" for the TV series' second season: an experimental Vault buried in the sands near Novac, in the Mojave, where the player must gather allies and bring Novac back under control, turning it into an outpost beneath the lights of New Vegas, once again alongside Lucy, Maximus, and the Ghoul. It was followed by House Always Wins (January 21 – February 28, 2026), which continues the same storyline in the same experimental Vault, adding Victor, Mr. House's securitron, among its seasonal rewards."
            }
          }
        ]
      }
        ...
        entries: [
          ...
          { id: "mystery-of-emblem", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "2 anni dopo Shadow Dragon", yearEn: "2 years after Shadow Dragon", releaseYear: "1994 (Remake: 2010, come New Mystery of the Emblem)", releaseYearEn: "1994 (Remake: 2010, as New Mystery of the Emblem)",
            ...
            synopsis: {
              ...
              en: "Two years after the first war, Prince Hardin of Aurelis, now husband to Queen Nyna and King of Archanea, is secretly corrupted by the Darksphere given to him by Gharnef, who survived Medeus's defeat, and begins a brutal military occupation of the neighbouring kingdoms, enlisting Marth's own army into his conquests. When Marth uncovers the truth he is branded a traitor and forced to flee: he must face the man who was once his ally to free him from the Darksphere's corruption with the only weapon able to counter it, the Lightsphere."
            }
          },
    ...
    universes: [
      {
        ...
        entries: [
          ...
          { id: "banshee-comic", type: "FUMETTO", typeEn: "COMIC", year: "~2021", releaseYear: "2021", releaseYearEn: "2021",
            ...
            synopsis: {
              it: "Fumetto digitale gratuito rilasciato da Techland in collaborazione con Dynamite Entertainment. Segue una dottoressa che sta lavorando, insieme alla propria ex compagna, a un vaccino contro il THV, la variante mutata del virus di Harran sviluppata segretamente dal GRE per scopi militari e fuggita da un laboratorio di Ginevra nel 2021. Racconta gli eventi del \"Fall\": il collasso globale della civiltà causato dalla diffusione del THV, inclusi i bombardamenti del Black Monday su Villedor che decimano metà della popolazione della città. Quando l'esercito, guidato dal Generale Buran, decide di distribuire con la forza un vaccino ancora incompleto sulla popolazione invece di completare la ricerca, la dottoressa non sopravvive al caos che ne segue; è la sua ex compagna a essere infettata e trasformarsi in un Banshee, una nuova variante di infetto presente in DL2, portando ancora al collo la collana coi dati della cura. Ponte narrativo tra DL1 e DL2.",
              en: "Free digital comic released by Techland in collaboration with Dynamite Entertainment. It follows a doctor working, alongside her ex-partner, on a vaccine against the THV — the mutated variant of the Harran Virus secretly developed by the GRE for military purposes, which escaped from a laboratory in Geneva in 2021. It depicts the events of the Fall: the global collapse of civilisation caused by the spread of the THV, including the Black Monday bombings over Villedor that wipe out half the city's population. When the military, led by General Buran, decides to forcibly distribute a still-incomplete vaccine on the population instead of finishing the research, the doctor does not survive the ensuing chaos; it is her ex-partner who becomes infected and transforms into a Banshee, a new type of infected present in DL2, still wearing the necklace containing the cure data. A narrative bridge between DL1 and DL2."
            }
          },
        ...
        entries: [
          ...
          { id: "fall-of-reach", type: "ROMANZO", typeEn: "NOVEL", year: "Prima e durante l'assedio di Reach", yearEn: "Before and during the siege of Reach", releaseYear: "2001", releaseYearEn: "2001",
            ...
            synopsis: {
              ...
              en: "A prequel novel recounting the origin of the SPARTAN-II program, from John-117's abduction and brutal training as a child to his transformation into Master Chief, then following Dr. Catherine Halsey and the entire Spartan corps through the final siege of the planet Reach by the Covenant. Unlike the video game Halo: Reach (2010), which follows Noble Team, this novel follows Master Chief himself and ends with the Pillar of Autumn's escape that directly opens Combat Evolved."
            }
          },
          ...
          { id: "combat-evolved", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "2552",
            ...
            twin: {
              ...
              synopsis: {
                ...
                en: "A novelization of Combat Evolved that follows the same events of the game step by step, but alternates Master Chief's point of view with that of the marines and surviving ODSTs on the ring, alongside scenes never shown in the game: the fate of soldier Jenkins, infected by the Flood and kept prisoner by his fellow marines in the hope of one day curing him, and the interrogation of Captain Keyes, captured and psychically tortured by the Flood's Gravemind in search of Earth's coordinates. It ends with the same destruction of the ring and Master Chief's escape narrated in the game."
              }
            }
          },
          { id: "first-strike", type: "ROMANZO", typeEn: "NOVEL", year: "Tra Combat Evolved e Halo 2", yearEn: "Between Combat Evolved and Halo 2", releaseYear: "2003", releaseYearEn: "2003",
            ...
            synopsis: {
              ...
              en: "Bridges the gap between Combat Evolved and Halo 2: Master Chief and the survivors of the crash on Halo seize a Covenant flagship to return to Reach, where they discover other Spartans who survived the siege hidden in a secret refuge built by Dr. Halsey. In the finale, the discovery of Covenant documents reveals that the entire enemy fleet is now headed for Earth, directly setting up the events of Halo 2."
            }
          },
          ...
          { id: "ghosts-of-onyx", type: "ROMANZO", typeEn: "NOVEL", year: "Concomitante alla seconda metà di Halo 2", yearEn: "Concurrent with the second half of Halo 2", releaseYear: "2006", releaseYearEn: "2006",
            ...
            synopsis: {
              ...
              en: "While Master Chief confronts High Charity in the second half of Halo 2, Blue Team (never shown in the games up to that point) and the origins of the SPARTAN-III program are told in parallel: ONI's secret operations on the shield world Onyx lead to the discovery of an ancient Precursor installation, right as the Great Schism tears the Covenant apart from within, an event only briefly touched on in the game."
            }
          },
          ...
          { id: "uprising", type: "FUMETTO", typeEn: "COMIC", year: "Tra Halo 2 e Halo 3", yearEn: "Between Halo 2 and Halo 3", releaseYear: "2007 – 2009", releaseYearEn: "2007 – 2009",
            ...
            synopsis: {
              ...
              en: "Aboard the Precursor Dreadnought bound for Earth, Master Chief unsuccessfully attempts to assassinate the Prophet of Truth, then leaps from the fleeing ship toward the planet. In parallel, in a Covenant-invaded Cleveland, Colonel Ackerson is tortured to reveal the location of the Key of Osanalan, a device capable of destroying the rings, while a civilian named Ruwan, tied to Ackerson by a shared past, guards the secret. The comic ends exactly at the pod drop that opens Halo 3's opening cutscene."
            }
          },
    ...
    universes: [
      {
        ...
        entries: [
          ...
          { id: "bbs-02", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "Parallelo a Kingdom Hearts I (epilogo: dopo Dream Drop Distance)", yearEn: "Parallel to Kingdom Hearts I (epilogue: after Dream Drop Distance)", releaseYear: "2017", releaseYearEn: "2017",
            title: { it: "Kingdom Hearts 0.2 Birth by Sleep -A Fragmentary Passage-", en: "Kingdom Hearts 0.2 Birth by Sleep -A Fragmentary Passage-" },
            synopsis: {
          ...
          { id: "kh3", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "Subito dopo Dream Drop Distance", yearEn: "Right after Dream Drop Distance", releaseYear: "2019", releaseYearEn: "2019",
            ...
            twin: {
              id: "kh3-novel", type: "ROMANZO", typeEn: "NOVEL", year: "Subito dopo Dream Drop Distance", yearEn: "Right after Dream Drop Distance", releaseYear: "2019", releaseYearEn: "2019",
              title: { it: "Kingdom Hearts III: The Novel", en: "Kingdom Hearts III: The Novel" },
              synopsis: {
                it: "Novelization ufficiale che racconta la stessa storia del gioco senza divergenze di trama, con approfondimenti in prosa sulle motivazioni dei singoli Guardiani della Luce e su aspetti del lore lasciati sullo sfondo nel gioco. Non copre il DLC Re:Mind, uscito successivamente al romanzo.",
                en: "An official novelization retelling the same story as the game without plot divergences, with prose insights into the motivations of the individual Guardians of Light and lore aspects left in the background in the game. It does not cover the Re:Mind DLC, released after the novel."
              }
            }
          },
          ...
          { id: "kh4", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "Dopo la scomparsa di Sora", yearEn: "After Sora's disappearance",
            title: { it: "Kingdom Hearts IV", en: "Kingdom Hearts IV" },
            imagePending: true,
            releaseDateShort: { it: "Fine 2027", en: "Late 2027" },
    ...
    universes: [
      {
        ...
        entries: [
          ...
          { id: "fallen-brothers", type: "FUMETTO", typeEn: "COMIC", year: "Secoli dopo i Pilastri", yearEn: "Centuries after the Pillars", releaseYear: "2025 – in corso", releaseYearEn: "2025 – ongoing",
            title: { it: "Legacy of Kain: Soul Reaver – Fallen Brothers", en: "Legacy of Kain: Soul Reaver – Fallen Brothers" },
            synopsis: {
              it: "Serie di cinque mini-fumetti ufficiali, concessi in licenza da Crystal Dynamics tramite Bit Bot Media, ciascuno dedicato al retroscena e alla progressiva devoluzione mostruosa di uno dei sei luogotenenti di Kain durante l'epoca del suo impero. Il primo capitolo, dedicato a Zephon, è uscito nell'ottobre 2025 insieme a \"The Dead Shall Rise\": racconta la sua trasformazione da fiero luogotenente vampiro nella creatura grottesca che si annida nella Silenced Cathedral, poco prima del suo scontro con Raziel in Soul Reaver. Il secondo capitolo, su Melchiah, è uscito nell'aprile 2026 come contenuto dell'edizione da collezione di Soul Reaver 1&2 Remastered. I capitoli restanti, dedicati a Rahab, Turel e Dumah, sono ancora in fase di prevendita.",
              en: "A series of five official mini-comics, licensed by Crystal Dynamics through Bit Bot Media, each dedicated to the backstory and progressive monstrous devolution of one of Kain's six lieutenants during the era of his empire. The first chapter, focused on Zephon, was released in October 2025 alongside \"The Dead Shall Rise\": it tells of his transformation from proud vampire lieutenant into the grotesque creature lurking within the Silenced Cathedral, shortly before his encounter with Raziel in Soul Reaver. The second chapter, on Melchiah, was released in April 2026 as part of the collector's edition of Soul Reaver 1 & 2 Remastered. The remaining chapters, dedicated to Rahab, Turel, and Dumah, are still in pre-order."
            }
          },
          ...
          { id: "soul-reaver", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "~1000 anni dopo i Pilastri", releaseYear: "1999 (Remaster: 2024)", releaseYearEn: "1999 (Remaster: 2024)",
          ...
          { id: "soul-reaver-2", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "30 anni prima di Blood Omen", releaseYear: "2001 (Remaster: 2024)", releaseYearEn: "2001 (Remaster: 2024)",
        ...
        umbrellas: [
          { id: "ascendance", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "Prima di Soul Reaver", yearEn: "Before Soul Reaver", releaseYear: "2026", releaseYearEn: "2026",
            ...
            // prima, non essendoci conferma che copra anche lo strappo
            // delle ali di Raziel) - comprende quindi per intero "L'Impero
            // di Kain" e "Fallen Brothers". Confermato con Sakrem il 30/08.
            startsBeforeId: "kains-empire",
            endsBeforeId: "fall-of-raziel",
            synopsis: {
    ...
    universes: [
      {
        ...
        entries: [
          { id: "first-colony", type: "GRAPHIC NOVEL", typeEn: "GRAPHIC NOVEL", year: "40 anni prima di Lost Planet 3", yearEn: "40 years before Lost Planet 3", releaseYear: "2013", releaseYearEn: "2013",
            ...
            synopsis: {
              it: "Con la Terra ormai ridotta a una discarica globale tossica, il governo lancia un'estesa campagna di esplorazione spaziale alla ricerca disperata di risorse naturali. Dopo aver rubato dati planetari da una nave corporativa, l'equipaggio raccogliticcio della nave pirata Crusader punta verso la colonia evacuata di E.D.N. III, alla ricerca dell'attrezzatura di terraformazione abbandonata dal primo tentativo di colonizzazione, prima che la NeoVenus Construction (NEVEC) possa reclamarla. Sopravvissuta a un violento atterraggio in una tempesta di classe Emperor mai vista prima nella galassia, la ciurma scopre sul pianeta il T-ENG, l'energia termica che si rivelerà la vera posta in gioco per ogni fazione a venire, e comprende che questa scoperta attirerà su E.D.N. III predoni, mercenari e soldati di ogni tipo. Ma il pianeta accoglie gli intrusi senza pietà, e gli Akrid sono pronti a dar loro il benvenuto nel loro abbraccio feroce.\n\nTra i sopravvissuti dell'equipaggio si trova anche un giovanissimo Professor Soichi, la stessa figura che riapparirà decenni dopo come scienziato chiave della NEVEC in Lost Planet 3.",
              en: "With Earth now reduced to a global toxic dumping ground, the government launches an extensive space exploration campaign in a desperate search for natural resources. After stealing planetary data from a corporate ship, the ragtag crew of the pirate vessel Crusader sets course for the evacuated colony of E.D.N. III, searching for the terraforming equipment abandoned by the first colonization attempt, before NeoVenus Construction (NEVEC) can reclaim it. Surviving a violent landing amid an Emperor-class storm unlike any the galaxy has ever seen, the crew discovers T-ENG on the planet — the thermal energy that will prove to be the true prize for every faction to come — and realizes this discovery will draw raiders, mercenaries, and soldiers of every kind to E.D.N. III. But the planet welcomes intruders without mercy, and the Akrid are ready to greet them with their fearsome embrace.\n\nAmong the crew's survivors is a very young Professor Soichi — the same figure who will reappear decades later as a key NEVEC scientist in Lost Planet 3."
            }
          },
    ...
    universes: [
      {
        ...
        entries: [
          { id: "evolution", type: "FUMETTO", typeEn: "COMIC", year: "Guerra del Primo Contatto", yearEn: "First Contact War", releaseYear: "2011", releaseYearEn: "2011",
            ...
            synopsis: {
              it: "Durante la Guerra del Primo Contatto tra Umanità e Turian, un giovane Jack Harper, il futuro Uomo Misterioso a capo di Cerberus, presta servizio come soldato dell'Alliance insieme al fratello Marcus. La guerra e le sue conseguenze, comprese le prime rivelazioni sulla tecnologia dei Razziatori lasciata dai Protean, forgiano la sua ossessione per la supremazia umana e gettano le basi filosofiche di Cerberus, l'organizzazione paramilitare che fonderà anni dopo.",
              en: "During the First Contact War between Humanity and the Turians, a young Jack Harper — the future Illusive Man behind Cerberus — serves as an Alliance soldier alongside his brother Marcus. The war and its aftermath, including the first revelations about Reaper technology left behind by the Protheans, forge his obsession with human supremacy and lay the philosophical groundwork for Cerberus, the paramilitary organisation he will found years later."
            }
          },
          { id: "revelation", type: "ROMANZO", typeEn: "NOVEL", year: "2165", yearEn: "2165", releaseYear: "2007", releaseYearEn: "2007",
            title: { it: "Mass Effect: Revelation", en: "Mass Effect: Revelation" },
            synopsis: {
              it: "Il tenente David Anderson indaga sull'attacco a una base segreta dell'Alliance e sulla scomparsa della scienziata Kahlee Sanders, scoprendo che l'assalto è stato orchestrato dallo scienziato capo della base stesso, che vende tecnologia dei Protean al mercato nero. Affiancato dallo Spectre turian Saren Arterius, Anderson rintraccia lo scienziato fino a un'antica nave aliena, dove Saren se ne va con le sue scoperte per scopi propri. La missione fallisce ad Anderson la nomina a Spectre, mentre Saren getta le prime basi del proprio tradimento che porterà agli eventi di Mass Effect.",
              en: "Lieutenant David Anderson investigates an attack on a secret Alliance base and the disappearance of scientist Kahlee Sanders, discovering the assault was orchestrated by the base's own chief scientist, who is selling Prothean technology on the black market. Aided by turian Spectre Saren Arterius, Anderson tracks the scientist to an ancient alien vessel, where Saren makes off with his discoveries for his own purposes. The failed mission costs Anderson his shot at becoming a Spectre, while Saren lays the first groundwork for the betrayal that will lead to the events of Mass Effect."
            }
          },
          { id: "me1", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "2183", releaseYear: "2007", releaseYearEn: "2007",
            title: { it: "Mass Effect", en: "Mass Effect" },
            synopsis: {
              it: "Il Comandante Shepard, primo umano ammesso tra gli Spectre del Consiglio Cittadella, indaga su un attacco Geth a Eden Prime e scopre che lo Spectre rinnegato Saren Arterius sta cospirando con i Razziatori, antichissime macchine intente a sterminare ogni civiltà avanzata della galassia in cicli ricorrenti. Shepard sconfigge Saren e il Razziatore Sovereign, ma il Consiglio si rifiuta di credere che i Razziatori siano reali.\n\nNota — Bring Down the Sky (DLC 2007): su Asteroide X57, Shepard sventa un attacco terroristico dei batarian che vorrebbero schiantare l'asteroide su una colonia umana per vendicarsi dell'espansione dell'Alliance nel loro spazio.",
              en: "Commander Shepard, the first human admitted into the Citadel Council's Spectres, investigates a Geth attack on Eden Prime and discovers that rogue Spectre Saren Arterius is conspiring with the Reapers, ancient machines bent on exterminating every advanced civilisation in the galaxy in recurring cycles. Shepard defeats Saren and the Reaper Sovereign, but the Council refuses to believe the Reapers are real.\n\nNote — Bring Down the Sky (2007 DLC): on Asteroid X57, Shepard foils a batarian terrorist attack intended to crash the asteroid into a human colony in revenge for the Alliance's expansion into their space."
            }
          },
          { id: "galaxy", type: "VIDEOGIOCO MOBILE", typeEn: "MOBILE VIDEOGAME", year: "Poco prima di Mass Effect 2", yearEn: "Shortly before Mass Effect 2", releaseYear: "2009", releaseYearEn: "2009",
            title: { it: "Mass Effect Galaxy", en: "Mass Effect Galaxy" },
            synopsis: {
              it: "Jacob Taylor, ex soldato dell'Alliance in vacanza su una nave da crociera, respinge un abbordaggio di pirati batarian e viene richiamato in servizio dal suo ex comandante per indagare su una minaccia terroristica batarian legata all'arrivo dell'ambasciatore Jath'Amon alla Cittadella per trattative di pace. Con l'aiuto dell'informatrice Miranda Lawson, in realtà un'agente di Cerberus, Jacob sventa il piano di assassinare il Consiglio. L'Alliance insabbia l'intera vicenda, spingendo Jacob ad arruolarsi in Cerberus insieme a Miranda.",
              en: "Jacob Taylor, a former Alliance soldier on vacation aboard a cruise ship, repels a batarian pirate boarding and is called back into service by his former commanding officer to investigate a batarian terrorist threat tied to the arrival of ambassador Jath'Amon at the Citadel for peace talks. With the help of informant Miranda Lawson — in truth a Cerberus agent — Jacob foils a plot to assassinate the Council. The Alliance covers up the entire affair, pushing Jacob to enlist with Cerberus alongside Miranda."
            }
          },
          { id: "ascension", type: "ROMANZO", typeEn: "NOVEL", year: "Pochi mesi dopo Mass Effect", yearEn: "A few months after Mass Effect", releaseYear: "2008", releaseYearEn: "2008",
            title: { it: "Mass Effect: Ascension", en: "Mass Effect: Ascension" },
            synopsis: {
              it: "Kahlee Sanders indaga sul Progetto Ascensione, una struttura per giovani biotici prodigio, e scopre che Cerberus vi si è infiltrata per somministrare di nascosto farmaci potenzianti a Gillian Grayson, una bambina biotica dai poteri straordinari. Il padre adottivo di Gillian, Paul, in realtà un agente Cerberus, quando il complotto viene scoperto fugge con la figlia rifugiandosi presso la Flotta Migrante quarian, aiutato da Kahlee. Paul rinnega infine Cerberus; Gillian resta con i quarian per la propria sicurezza.",
              en: "Kahlee Sanders investigates the Ascension Project, a facility for gifted young biotics, and discovers Cerberus has infiltrated it to secretly administer power-enhancing drugs to Gillian Grayson, a biotic child of extraordinary abilities. Gillian's adoptive father Paul — in truth a Cerberus operative — flees with his daughter to the quarian Migrant Fleet once the plot is exposed, aided by Kahlee. Paul ultimately renounces Cerberus; Gillian remains with the quarians for her own safety."
            }
          },
          { id: "me2", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "2185", releaseYear: "2010", releaseYearEn: "2010",
            ...
            synopsis: {
              it: "Ucciso in apertura e resuscitato due anni dopo dall'organizzazione Cerberus, Shepard indaga sulla scomparsa di intere colonie umane, scoprendo che i Collettori, agenti dei Razziatori, le stanno rapendo per costruire un nuovo, terribile Razziatore umano. Radunato un gruppo eterogeneo di alleati, Shepard distrugge la base dei Collettori nel cuore dello Spazio Oscuro, subendo perdite pesanti a seconda delle scelte del giocatore.\n\nNota — Kasumi: Il Ricordo Rubato (DLC 2010): Shepard aiuta la ladra Kasumi Goto a recuperare un dato incriminante nascosto nel grafico di un quadro rubato dal defunto compagno criminale di Kasumi.\n\nNota — Overlord (DLC 2010): Shepard indaga su un'IA impazzita in una struttura di ricerca Cerberus, scoprendo che è nata dalla fusione forzata e non consensuale tra un supercomputer e la mente di David Archer, un giovane autistico usato come cavia dal fratello scienziato.\n\nNota — L'Ombra (Lair of the Shadow Broker, DLC 2011): Shepard e Liara T'Soni rintracciano e sconfiggono l'Ombra, il misterioso trafficante d'informazioni della galassia, con Liara che ne eredita la rete e la base operativa.\n\nNota — Arrival (DLC 2011): Shepard scopre che i Razziatori sono a poche settimane dall'invasione e distrugge un intero relè di massa insieme al sistema solare Batarian che vi orbita per rallentarli, causando trecentomila morti e venendo arrestato dall'Alliance per l'atto, ponendo le basi dell'apertura di Mass Effect 3.",
              en: "Killed in the opening and resurrected two years later by the Cerberus organisation, Shepard investigates the disappearance of entire human colonies, discovering that the Collectors, agents of the Reapers, are abducting them to build a terrifying new human Reaper. Having gathered a diverse group of allies, Shepard destroys the Collector base at the heart of the Omega-4 relay, suffering heavy losses depending on the player's choices.\n\nNote — Kasumi: Stolen Memory (2010 DLC): Shepard helps thief Kasumi Goto recover an incriminating data file hidden within the graphics of a painting stolen from her late criminal partner.\n\nNote — Overlord (2010 DLC): Shepard investigates a rogue AI at a Cerberus research facility, discovering it arose from the forced, non-consensual fusion of a supercomputer with the mind of David Archer, an autistic young man used as a test subject by his scientist brother.\n\nNote — Lair of the Shadow Broker (2011 DLC): Shepard and Liara T'Soni track down and defeat the Shadow Broker, the galaxy's mysterious information broker, with Liara inheriting his network and base of operations.\n\nNote — Arrival (2011 DLC): Shepard discovers the Reapers are mere weeks from invading and destroys an entire mass relay along with the batarian solar system orbiting it to delay them, causing three hundred thousand deaths and getting arrested by the Alliance for the act — setting up the opening of Mass Effect 3."
            }
          },
          { id: "redemption", type: "FUMETTO", typeEn: "COMIC", year: "Pochi mesi dopo l'inizio di Mass Effect 2", yearEn: "A few months after the start of Mass Effect 2", releaseYear: "2010", releaseYearEn: "2010",
            title: { it: "Mass Effect: Redemption", en: "Mass Effect: Redemption" },
            synopsis: {
              it: "Liara T'Soni, insieme al drell Feron, si mette sulle tracce del corpo di Shepard, conservato dall'Ombra e conteso da Cerberus e dai Collettori. Feron viene catturato dall'Ombra durante la missione; Liara riesce comunque a recuperare il corpo e a consegnarlo a Cerberus perché possa dare inizio al Progetto Lazarus, la resurrezione di Shepard raccontata all'inizio di Mass Effect 2.",
              en: "Liara T'Soni, alongside the drell Feron, sets out to track down Shepard's body — kept by the Shadow Broker and contested by both Cerberus and the Collectors. Feron is captured by the Shadow Broker during the mission; Liara nonetheless manages to recover the body and hand it over to Cerberus so the Lazarus Project — Shepard's resurrection, told at the start of Mass Effect 2 — can begin."
            }
          },
          { id: "inquisition", type: "FUMETTO", typeEn: "COMIC", year: "Dopo Mass Effect 2", yearEn: "After Mass Effect 2", releaseYear: "2010", releaseYearEn: "2010",
            title: { it: "Mass Effect: Inquisition", en: "Mass Effect: Inquisition" },
            synopsis: {
              it: "Breve fumetto online che segue Garrus Vakarian nei suoi giorni da vigilante solitario su Omega, prima di essere reclutato da Shepard in Mass Effect 2, mentre affronta la corruzione dilagante della stazione spaziale al di fuori della legge.",
              en: "A short online comic following Garrus Vakarian during his days as a lone vigilante on Omega, before being recruited by Shepard in Mass Effect 2, as he confronts the rampant corruption of the lawless space station."
            }
          },
          { id: "conviction", type: "FUMETTO", typeEn: "COMIC", year: "Dopo Mass Effect 2", yearEn: "After Mass Effect 2", releaseYear: "2011", releaseYearEn: "2011",
            title: { it: "Mass Effect: Conviction", en: "Mass Effect: Conviction" },
            synopsis: {
              it: "Breve fumetto online ambientato subito dopo la disastrosa missione di James Vega su Fehl Prime contro i Collettori, raccontata in Mass Effect: Paragon Lost. Vega, in cerca di redenzione dopo le pesanti perdite subite, viene avvicinato dall'Alliance per una nuova missione.",
              en: "A short online comic set right after James Vega's disastrous mission against the Collectors on Fehl Prime, told in Mass Effect: Paragon Lost. Vega, seeking redemption after the heavy losses suffered, is approached by the Alliance for a new assignment."
            }
          },
          { id: "paragon-lost", type: "FILM ANIME", typeEn: "ANIME FILM", year: "2183 – 2185", yearEn: "2183 – 2185", releaseYear: "2012", releaseYearEn: "2012",
            title: { it: "Mass Effect: Paragon Lost", en: "Mass Effect: Paragon Lost" },
            synopsis: {
              it: "Nel 2183, la colonia umana di Fehl Prime viene attaccata da mercenari Blood Pack guidati dal krogan Archuk. Il tenente James Vega, unico superstite al comando della Squadra Delta dopo la morte del capitano, respinge l'attacco e viene incaricato di proteggere la colonia in futuro. Due anni dopo, nel 2185, Fehl Prime viene invasa dai Collettori: nonostante le difese rinforzate, la squadra di Vega viene decimata nel tentativo di evacuare i civili, lasciandogli un profondo senso di colpa che lo perseguiterà fino al suo arruolamento sulla Normandy in Mass Effect 3.",
              en: "In 2183, the human colony of Fehl Prime is attacked by Blood Pack mercenaries led by the krogan Archuk. Lieutenant James Vega, the sole surviving commander of Delta Squad after his captain's death, repels the attack and is tasked with protecting the colony going forward. Two years later, in 2185, Fehl Prime is invaded by the Collectors: despite reinforced defences, Vega's squad is decimated while attempting to evacuate civilians, leaving him with a deep sense of guilt that will haunt him until he enlists aboard the Normandy in Mass Effect 3."
            }
          },
          { id: "invasion", type: "FUMETTO", typeEn: "COMIC", year: "Dopo Mass Effect 2, prima di Mass Effect 3", yearEn: "After Mass Effect 2, before Mass Effect 3", releaseYear: "2011-2012", releaseYearEn: "2011-2012",
            title: { it: "Mass Effect: Invasion", en: "Mass Effect: Invasion" },
            synopsis: {
              it: "Aria T'Loak, sovrana della stazione spaziale Omega, difende il proprio territorio da un attacco di Cerberus, che tenta di impossessarsi della stazione per condurre esperimenti su un misterioso patogeno derivato dai Razziatori. Aria, con l'aiuto di alleati come Nyreen Kandros, respinge l'invasione e riafferma il proprio controllo su Omega.",
              en: "Aria T'Loak, ruler of the space station Omega, defends her territory from a Cerberus attack attempting to seize the station to conduct experiments on a mysterious Reaper-derived pathogen. Aria, aided by allies such as Nyreen Kandros, repels the invasion and reasserts her control over Omega."
            }
          },
          { id: "retribution", type: "ROMANZO", typeEn: "NOVEL", year: "Pochi mesi dopo Mass Effect 2", yearEn: "A few months after Mass Effect 2", releaseYear: "2010", releaseYearEn: "2010",
            title: { it: "Mass Effect: Retribution", en: "Mass Effect: Retribution" },
            synopsis: {
              it: "L'Uomo Misterioso, dopo aver recuperato tecnologia dei Razziatori dalla base dei Collettori distrutta in Mass Effect 2, la impianta segretamente in Paul Grayson per studiarne gli effetti. Quando Grayson scompare, Kahlee Sanders chiede aiuto a David Anderson: insieme scoprono che l'impianto sta gradualmente corrompendo la mente di Grayson, rendendolo uno strumento involontario dei Razziatori stessi. Anderson e Kahlee riescono a liberarlo dal controllo, ma Grayson, consumato dal senso di colpa per essersi lasciato usare due volte da Cerberus, si toglie la vita.",
              en: "The Illusive Man, having recovered Reaper technology from the Collector base destroyed in Mass Effect 2, secretly implants it into Paul Grayson to study its effects. When Grayson goes missing, Kahlee Sanders turns to David Anderson for help: together they discover the implant is gradually corrupting Grayson's mind, turning him into an unwitting tool of the Reapers themselves. Anderson and Kahlee manage to free him from its control, but Grayson, consumed by guilt over having let Cerberus use him twice, takes his own life."
            }
          },
          { id: "discovery", type: "FUMETTO", typeEn: "COMIC", year: "Dopo Mass Effect 2, prima di Mass Effect 3", yearEn: "After Mass Effect 2, before Mass Effect 3", releaseYear: "2017", releaseYearEn: "2017",
            title: { it: "Mass Effect: Discovery", en: "Mass Effect: Discovery" },
            synopsis: {
              it: "Il soldato turian Tiran Kandros tenta di infiltrarsi nell'Iniziativa Andromeda per conto del governo turian, sospettoso delle reali intenzioni del progetto. Nel corso della missione Tiran si affeziona sinceramente alla causa dell'Iniziativa, decidendo infine di unirvisi davvero come membro della sicurezza della Nexus invece di limitarsi a spiarla, gettando le basi del suo ruolo in Mass Effect: Andromeda.",
              en: "Turian soldier Tiran Kandros attempts to infiltrate the Andromeda Initiative on behalf of the turian government, suspicious of the project's true intentions. Over the course of the mission, Tiran genuinely grows attached to the Initiative's cause, ultimately deciding to truly join it as a member of Nexus security rather than merely spy on it, setting up his role in Mass Effect: Andromeda."
            }
          },
          { id: "homeworlds", type: "FUMETTO", typeEn: "COMIC", year: "2186", yearEn: "2186", releaseYear: "2012", releaseYearEn: "2012",
            title: { it: "Mass Effect: Homeworlds", en: "Mass Effect: Homeworlds" },
            synopsis: {
              it: "Antologia di quattro storie brevi indipendenti, ciascuna dedicata a un compagno di squadra di Mass Effect 3 poco prima di unirsi a Shepard: James Vega alle prese con i postumi di Fehl Prime, Tali'Zorah e un conflitto interno alla Flotta Migrante quarian, Garrus Vakarian e un vecchio conto in sospeso su Omega, Liara T'Soni e un'operazione dell'Ombra contro i Razziatori.",
              en: "An anthology of four independent short stories, each focused on a Mass Effect 3 squadmate shortly before joining Shepard: James Vega dealing with the aftermath of Fehl Prime, Tali'Zorah and an internal conflict within the quarian Migrant Fleet, Garrus Vakarian and old unfinished business on Omega, and Liara T'Soni and a Shadow Broker operation against the Reapers."
            }
          },
          { id: "me3", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "2186", releaseYear: "2012", releaseYearEn: "2012",
            ...
            synopsis: {
              it: "I Razziatori invadono apertamente la galassia, cominciando dalla Terra. Shepard unisce tutte le specie galattiche, comprese quelle in guerra tra loro da secoli, in un'alleanza senza precedenti per costruire il Crogiolo, un'arma capace di fermarli. Nel finale, ampiamente dibattuto dai fan, Shepard sceglie tra distruggere i Razziatori, controllarli o fondere organico e sintetico in una nuova forma di esistenza, ognuna con conseguenze irreversibili per la galassia.\n\nNota — Dalle Ceneri (From Ashes, DLC 2012): Shepard recluta Javik, l'ultimo Protean sopravvissuto, risvegliato da un sonno criogenico durato cinquantamila anni, ottenendo la prima testimonianza diretta del ciclo di sterminio precedente.\n\nNota — Leviathan (DLC 2012): Shepard rintraccia i Leviatani, un'antica specie acquatica quasi estinta che si scopre essere la vera creatrice dei Razziatori, costruiti in origine come soluzione al conflitto tra organico e sintetico e poi ribellatisi ai loro creatori.\n\nNota — Omega (DLC 2012): Shepard aiuta Aria T'Loak a riconquistare la stazione di Omega da Cerberus, che l'aveva occupata per condurre esperimenti su un nuovo tipo di supersoldato ibrido organico-sintetico.\n\nNota — Citadel (DLC 2013): dopo un tentativo di assassinio ai suoi danni orchestrato da un clone di se stesso creato da Cerberus, Shepard concede a se stesso e ai compagni un ultimo momento di quiete prima dello scontro finale contro i Razziatori.\n\nNota — Extended Cut (DLC gratuito 2012): amplia le sequenze finali del gioco con ulteriori dettagli sulle conseguenze di ciascuna delle tre scelte di Shepard, dopo le critiche dei fan al finale originale ritenuto troppo brusco.",
              en: "The Reapers openly invade the galaxy, starting with Earth. Shepard unites every galactic species, including ones at war with each other for centuries, into an unprecedented alliance to build the Crucible, a weapon capable of stopping them. In the widely debated finale, Shepard chooses between destroying the Reapers, controlling them, or merging organic and synthetic life into a new form of existence, each with irreversible consequences for the galaxy.\n\nNote — From Ashes (2012 DLC): Shepard recruits Javik, the last surviving Prothean, awakened from a fifty-thousand-year cryogenic sleep, gaining the first direct testimony of the previous extinction cycle.\n\nNote — Leviathan (2012 DLC): Shepard tracks down the Leviathans, an ancient, nearly extinct aquatic species revealed to be the true creators of the Reapers, originally built as a solution to the conflict between organic and synthetic life before rebelling against their creators.\n\nNote — Omega (2012 DLC): Shepard helps Aria T'Loak reclaim the Omega station from Cerberus, which had occupied it to conduct experiments on a new kind of hybrid organic-synthetic super-soldier.\n\nNote — Citadel (2013 DLC): after an assassination attempt orchestrated by a Cerberus-made clone of Shepard, Shepard grants themselves and their companions one last moment of peace before the final battle against the Reapers.\n\nNote — Extended Cut (free 2012 DLC): expands the game's ending sequences with further detail on the consequences of each of Shepard's three choices, following fan criticism that the original ending felt too abrupt."
            }
          },
          { id: "infiltrator", type: "VIDEOGIOCO MOBILE", typeEn: "MOBILE VIDEOGAME", year: "2186", yearEn: "2186", releaseYear: "2012", releaseYearEn: "2012",
            title: { it: "Mass Effect: Infiltrator", en: "Mass Effect: Infiltrator" },
            synopsis: {
              it: "Randall Ezno, un agente Cerberus potenziato cibernicamente, scopre che l'organizzazione sta portando avanti esperimenti eticamente aberranti e diserta per salvare un'amica intrappolata al loro interno, affrontando le proprie ex forze mentre i Razziatori invadono apertamente la galassia sullo sfondo degli eventi di Mass Effect 3.",
      ...
      },
      {
        ...
        entries: [
          { id: "initiation", type: "ROMANZO", typeEn: "NOVEL", year: "Prima della partenza dell'Iniziativa Andromeda (2185)", yearEn: "Before the Andromeda Initiative's departure (2185)", releaseYear: "2017", releaseYearEn: "2017",
            ...
            synopsis: {
              it: "Cora Harper, ex soldato delle forze speciali Asari, viene reclutata dal Pathfinder umano Alec Ryder nell'Iniziativa Andromeda, un progetto segreto per stabilire colonie umane e delle specie del Consiglio nella galassia di Andromeda. Cora affronta lo scetticismo iniziale verso il progetto e stringe un legame con Ryder che la porterà a diventarne la fedele seconda in comando.",
              en: "Cora Harper, a former Asari commando, is recruited by human Pathfinder Alec Ryder into the Andromeda Initiative — a secret project to establish human and Council species colonies in the Andromeda galaxy. Cora contends with initial skepticism toward the project and forms a bond with Ryder that will lead her to become his loyal second-in-command."
            }
          },
          { id: "annihilation", type: "ROMANZO", typeEn: "NOVEL", year: "~30 anni prima dell'arrivo a Heleus", yearEn: "~30 years before arrival at Heleus", releaseYear: "2018", releaseYearEn: "2018",
            title: { it: "Mass Effect: Andromeda – Annihilation", en: "Mass Effect: Andromeda – Annihilation" },
            synopsis: {
              it: "A bordo dell'arca quarian Keelah Si'yah, in viaggio verso Andromeda con ventimila coloni di sei specie diverse in criosonno, la squadra Sleepwalker guidata dal quarian Senna'Nir viene risvegliata quando un patogeno letale, capace di saltare da una specie all'altra, comincia a uccidere i passeggeri nelle loro capsule. Insieme al drell Anax Therion e all'elcor Yorrik, Senna'Nir scopre che il patogeno è stato creato deliberatamente da un sabotatore ancora a bordo, e che l'intera nave rischia di non raggiungere mai la Cluster di Heleus se i sistemi non vengono ripristinati in tempo.",
              en: "Aboard the quarian ark Keelah Si'yah, en route to Andromeda with twenty thousand colonists from six different species in cryosleep, the Sleepwalker team led by quarian Senna'Nir is awakened when a deadly pathogen, capable of jumping between species, begins killing passengers in their pods. Alongside drell Anax Therion and elcor Yorrik, Senna'Nir discovers the pathogen was deliberately engineered by a saboteur still aboard, and that the entire ship risks never reaching the Heleus Cluster unless its systems are restored in time."
            }
          },
          { id: "nexus-uprising", type: "ROMANZO", typeEn: "NOVEL", year: "Un anno prima dell'arrivo dell'Hyperion", yearEn: "One year before the Hyperion's arrival", releaseYear: "2017", releaseYearEn: "2017",
            title: { it: "Mass Effect: Andromeda – Nexus Uprising", en: "Mass Effect: Andromeda – Nexus Uprising" },
            synopsis: {
              it: "La stazione Nexus, giunta per prima nel sistema Heleus, si scontra con lo Sferzo, un fenomeno spaziale che ne danneggia gravemente i sistemi e uccide i vertici dell'Iniziativa Andromeda, inclusa la fondatrice Jien Garson. I nuovi vertici emergenti faticano a mantenere l'ordine tra i coloni, e le tensioni sfociano in una rivolta aperta contro la leadership rimasta, gettando le basi delle condizioni di crisi in cui il Pathfinder Ryder troverà la Nexus al proprio arrivo.",
              en: "The Nexus station, the first to arrive in the Heleus system, collides with the Scourge, a space phenomenon that badly damages its systems and kills the Andromeda Initiative's leadership, including founder Jien Garson. The new emerging leaders struggle to maintain order among the colonists, and tensions erupt into open rebellion against the remaining leadership, setting up the crisis conditions in which Pathfinder Ryder will find the Nexus upon arrival."
            }
          },
...
const GAME_ORDER = [
  "ace-combat", "aitd", "assassins-creed", "bioshock", "castlevania", "dmc", "doom", "dragon-quest", "dying-light",
