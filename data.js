    ...
    universes: [
      {
        ...
        entries: [
          ...
          { id: "fallout-1", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "2161", releaseYear: "1997", releaseYearEn: "1997",
            title: { it: "Fallout", en: "Fallout" },
            synopsis: {
              it: "Il Vault 13, in California, rischia di esaurire il chip idrico che ne garantisce la sopravvivenza. L'Abitante del Vault viene inviato in superficie a recuperarne uno sostitutivo, scoprendo lungo il cammino il piano del Master, un essere mutante che vuole assimilare l'intera umanità superstite in un unico organismo collettivo. Il gioco capostipite dell'intera saga.",
          ...
          { id: "fallout-2", type: "VIDEOGIOCO", typeEn: "VIDEOGAME", year: "2241", releaseYear: "1998", releaseYearEn: "1998",
            ...
            synopsis: {
              it: "Ottant'anni dopo il primo gioco, il Prescelto parte dal villaggio di Arroyo, fondato dai discendenti del primo Vault Dweller, alla ricerca di un G.E.C.K. (Garden of Eden Creation Kit), un dispositivo capace di rendere di nuovo fertile la terra. Lungo il viaggio scopre i piani dell'Enclave, resti del governo pre-guerra intenzionati a sterminare ogni forma di vita mutata per ripopolare l'America con i soli «puri».",
