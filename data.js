...
,
  ...
  doom: {
    ...
    noTimeline: true,
    canonNote: {
      it: "A differenza degli altri franchise di questo archivio, Doom non ha mai avuto una continuità narrativa ufficiale e confermata dagli sviluppatori. I giochi originali (1993-1994) nacquero praticamente senza trama: la storia era un pretesto, non un progetto. Quello che oggi viene chiamato \"canon\" è stato ricostruito nel tempo, per lo più dai fan, e solo in parte confermato da dichiarazioni vaghe di id Software, che non ha mai chiarito se il Doom classico e il Doom moderno condividano la stessa Terra o siano due mondi paralleli invasi dallo stesso Inferno.\n\nEsiste comunque una progressione ampiamente accettata e piuttosto credibile, che segue lo stesso protagonista, prima Doomguy poi Doom Slayer, attraverso: Doom (1993), Doom II: Hell on Earth, Final Doom, Doom 64, Doom: The Dark Ages, Doom (2016), Doom VFR e Doom Eternal. Il collegamento tra le due epoche è stato ricostruito a posteriori attraverso i Codex e le cutscene dei giochi più recenti, non da un piano narrativo originario.",
      en: "Unlike the other franchises in this archive, Doom has never had an official, developer-confirmed narrative continuity. The original games (1993-1994) were essentially written without a real story: the plot was an afterthought, not a design goal. What is called \"canon\" today was pieced together over time, mostly by fans, and only partially confirmed through vague statements from id Software, which has never clarified whether classic Doom and modern Doom share the same Earth or are parallel worlds invaded by the same Hell.\n\nThat said, a widely accepted and fairly credible progression does exist, following the same protagonist, first Doomguy then the Doom Slayer, through: Doom (1993), Doom II: Hell on Earth, Final Doom, Doom 64, Doom: The Dark Ages, Doom (2016), Doom VFR, and Doom Eternal. The connective tissue between the two eras was reconstructed after the fact through Codex entries and cutscenes in the newer games, rather than an original narrative plan."
    }
  },
  "dragon-quest": {
    id: "dragon-quest",
