...
const STRINGS = {
  it: {
    ...
    ffixFull11: "La trama prosegue portandoci in località via via più memorabili: quella affascinante di Lindblum, con il suo simpaticissimo re trasformato in una specie di scarafaggio saltellante (uno Scaraburi, e no, non sto scherzando, è davvero un re-insetto e nessuno nella storia sembra trovarlo strano), oppure quella devastata di Burmesia, con tutto il background di Freija che sulla carta dovrebbe colpirmi al cuore, e che invece mi ha lasciato solo la fredda soddisfazione di aver reclutato un altro personaggio da tenere in panchina. Tutto questo per scoprire, alla fine, che la vera cattiva è proprio la regina Brahne: un personaggio abbastanza rilevante da scagliarci contro la sua fidata Beatrix (vi lascio un'immagine qui sotto, così capite quanto sia bella nonostante la grafica di FFIX) e i pagliacci Zon e Son, che fanno da carcerieri a Garnet per un breve tratto a metà gioco... e da pagliacci, ovviamente, tutte le volte che compaiono, senza mai un giorno di riposo dal ruolo.",
  ...
  en: {
    ...
    ffixFull09: "Shame about Blank, though: he won't be freed from petrification until near the end of the game (so no, he's not dead, don't worry), but he struck me as having the potential to become a great future party member, a proper badass swordsman. Instead we get stuck with Steiner, the tin can who spends his time hassling Zidane for the sole, unforgivable crime of getting too close to Garnet. Vivi, please, throw him a spell to chew on and keep him occupied, do it for all of us.",
    ...
    ffixFull15: "Sure, at this point it might sound like I don't like anyone, but that's not true: I saved my favorite addition for last, Quina. A frog, yes, but an absolutely hilarious one, who talks in that same broken, endearingly garbled English as ever, and thinks about food in literally every waking moment, no breaks, no exceptions. If I were a female frog, I'd probably be identical to her. Or maybe it'd be enough to just be female, full stop, no frog required.",
