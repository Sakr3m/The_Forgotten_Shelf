...
const STRINGS = {
  ...
  en: {
    ...
    ffviiiFull06: "The rest of the playable cast tends to get overshadowed by the two leads, forgotten by the plot not too long after being introduced, pushed into the background or left in a spot where you have to dig into the tiniest details just to understand how they evolve; the kind of details only a hardcore fan or a psychopath could ever spot.",
    ffviiiFull07: "Personally, I've never seen this as a major issue. It's a real trait of the game, and one that gets a lot of criticism from both some fans and, even more so, from non-fans of the title, but I still think it was handled well enough to let you catch glimpses of meaningful growth even in these side characters.",
    ffviiiFull08: "One case worth dwelling on is Selphie Tilmitt: normally a cheerful, outgoing girl, who after visiting Trabia Garden, destroyed by a missile strike, disappears from the scene for a while under the excuse of needing to rest. The game never shows it outright, but it's not hard to imagine that the event left real scars on her, enough to send her off alone to her room, maybe to cry it out or just process it.",
    ffviiiFull09: "Zell Dincht changes quite a bit too: from \"chicken-wuss\" (as Seifer Almasy calls him) itching to take charge, to a member who learns to stay in his lane, earning, for a very short stretch of time, a role of responsibility that's anything but minor (squad leader, no less), right at the moment he finally accepts to grow past that side of himself.",
    ffviiiFull10: "The same goes for Quistis Trepe and Irvine Kinneas, who are no exception.",
    ffviiiFull11: "In short, these are characters who need to be understood, not just ordered around.",
    ffviiiFull12: "Among the other characters worth mentioning outside the core group, there's the aforementioned Seifer, with his odd quirks, the kind that make you want to give him a good headbutt every now and then, free therapy session included, and his endless rivalry with Squall, which only seems to settle down at the very end of the game, in the credits, not before. Always flanked by his trusty Fujin and Raijin, a pair of... schoolyard bullies who seem to see Seifer as something between a squad leader and a small-time dictator.",
    ffviiiFull13: "Edea Kramer, who's impossible to hate no matter how hard you try, given her condition as a puppet, possessed by a sorceress from the future. I've never fully figured out how I feel about her, not even after freeing her from the possession; sometimes she talks like she knows something, but with the initiative of a Tonberry that's still holding its knife down: you know it's coming eventually, but you've got plenty of time to grab a coffee in the meantime.",
    ffviiiFull14: "In dreams, in the most literal sense of the word, we find Laguna Loire and his two loyal companions, Kiros Seagill and Ward Zabac, three Galbadian soldiers who get into all sorts of trouble. I'll give them this, though: courage isn't in short supply, throwing themselves off a cliff without batting an eye is basically routine for them. Honestly, though, it was Laguna who threw both of them and himself off, so maybe he's the real madman of the trio.",
    ffviiiFull15: "And let me give a shoutout to those two clowns, Wedge and Biggs, whose last names remain an unsolvable mystery: absolutely likable, full stop.",
    ffviiiFull16: "The story, for its part, starts out as a kind of \"slice of life\" set in a school, military as it may be, made of training sessions in cramped (and occasionally maze-like) caves, missions to climb ranks, and promotions. That last bit involves *ridiculously easy* tests to rank up as a SeeD, the name of the military unit our characters belong to, earning more money to spend on all the gear or souvenirs you feel like buying. Before gradually turning into a full-blown witch hunt, minus the pitchforks and torches, always with that distinctive old-school Final Fantasy flavor.",
    ffviiiFull17: "I know full well that tonal shifts like this one don't land for everyone, but I loved it precisely because it feels like a natural consequence of the setup: a \"I was supposed to get here from the start, I was just stuck proving how well I can handle a gunblade\" kind of moment.",
    ffviiiFull18: "Speaking of the gunblade! A genius weapon, I'll admit it, a fusion, kind of like the one you get with the Potara earrings in Dragon Ball, between a sword and a gun/rifle, but it's still gorgeous, and in combat its mechanic sells the idea perfectly.",
    ffviiiFull19: "As things move along, the story evolves in completely unexpected ways: Squall, from being the sole owner and user (alongside his rival Seifer) of the gunblade, becomes Commander of Balamb Garden, but not before dragging us poor players through a string of ordeals, including: escaping a maximum-security prison built to be inescapable, with its exits constantly being buried in sand; defeating in combat the true owner of Balamb Garden (NORG, the self-styled Garden Master), who was holding Headmaster Cid Kramer hostage; and passing out from time to time, in places that aren't always pleasant, to relive the missions of Laguna Loire (Squall's father) and his companions, including that one time he got a cramp mid-flirt with a pianist destined to become a singer (and Rinoa's mother).",
    ffviiiFull20: "All of this leads our characters to face Edea in a stunning war against Galbadia and its Garden, through moments that keep you glued to the screen and cutscenes that make you set down the controller (or pull your hands away from mouse and keyboard), before finally arriving, in the future, through time compression, at the gates of Ultimecia's castle, the game's main antagonist, and defeating her.",
    ffviiiFull21: "If you don't know what time compression is, well, it's simple: take the past, present, and future, throw them in a blender, hit \"on\", and there you go, you've got \"time compression\".",
    ffviiiFull22: "Every step of the way is paired with events and, above all, fantastic scenes and cutscenes, which on their own, with no other reward attached, would already be worth the effort.",
    ffviiiFull23: "Oh right, did I mention we also go to space?",
    ffviiiFull24: "Speaking of sorceresses and space, let me open a parenthesis: Adel is a man, and you won't convince me otherwise.",
    ffviiiFull25: "There's a legend told in the game about Hyne, a great being who created humans to serve him; when they rebelled and wanted his powers, he granted them, right before fleeing, but only to women, and only a chosen few. So Adel, or however the name is actually spelled, should be a woman. With that chest, though? I refuse to believe it, not even under torture. Judge for yourselves.",
    ffviiiFull26: "Moving on to the combat system, let's get this out of the way first: it doesn't offer much in terms of battle mechanics, but outside of battle it's a whole different story.",
    ffviiiFull27: "The Junction system is absolutely busted: if you know how to use it, you can sow death and destruction through the ranks of your enemies. This ties directly into the enemy level scaling system: FFVIII is supposed to adjust monster difficulty to the party's average level, but in practice, more often than not, the difference is basically unnoticeable.",
    ffviiiFull28: "Spells, on the other hand, if it weren't for their role in Junction, boosting your characters' stats (on top of regular leveling), would be completely useless, replaceable even by a dog fired off like a cannonball; and I'm not joking in the slightest: Rinoa's dog (a female named Angelo) can literally do that, and more effectively than half the spell list.",
    ffviiiFull29: "A few spells still earn their keep thanks to being absurdly useful, but there are so few of them you can count them on the fingers of one hand.",
    ffviiiFull30: "On top of that, these spells have to be drawn from enemies or from these strange pink sources that pop out of the ground; yeah, I know, that second option sounds even more absurd than the first, considering the ground could just as easily produce geysers, magma, or who knows what mysterious fumes. Maybe what we're actually \"drawing\", or rather inhaling, are hallucinogenic fumes that trick us into thinking we've unlocked the ability to summon a massive fireball under our opponent's backside (Firaga), or bring our fallen teammates back to life (Full-life).",
    ffviiiFull31: "And then there are the Guardian Forces, entities with wildly different looks, mostly monstrous, except for Shiva, who's hot. Siren holds up decently too, honestly. When summoned at the right moment, these beings can completely flip the outcome of a battle. Honorable mention to Odin, Gilgamesh, and Phoenix, who, go figure, can't be summoned manually and just show up whenever they feel like it; Phoenix is a partial exception, since you can also call her in through an item (the Phoenix Pinion), but the automatic version is still the better option, genuinely capable of saving you from a Game Over. Another honorable mention goes to Ifrit, for no particular reason, it's simply my favorite in this entry of the series.",
    ffviiiFull32: "Back to the Guardian Forces: they can be drawn from bosses or monsters, or found in various secret spots scattered around the world.",
    ffviiiFull33: "And there are plenty of spots like that on the map, both for finding Guardian Forces and for minigames: you'll genuinely lose yourself trying to do it all. Grab a guide if you're going for the platinum.",
    ffviiiFull34: "That said, outside of these hidden locations, actual towns and villages aren't exactly plentiful, which leaves the world feeling a bit sparse. Then again, this was the PlayStation 1 era, so it's understandable.",
    ffviiiFull35: "None of that takes away from how fun it is to roam the map far and wide, first with Balamb Garden in its flying form, then with the Ragnarok. Honestly, in my opinion, Esthar and Deling City still look absolutely stunning, design-wise (not level design-wise).",
    ffviiiFull36: "Finding the hidden Guardian Force locations, the minigames, the Deep Sea Research Center, every last chocobo forest, or heading off to train in places called the \"Island Closest to Hell\" and the \"Island Closest to Heaven,\" home to Ruby Dragons and Malboros: a dream. Actually, wait, Malboros are more of a nightmare with tentacles: let's not go there.",
    ffviiiFull37: "And now, finally, we get to talk about the minigame to end all minigames, the real drug of this entire game: Triple Triad, a collectible card game you play against NPCs (not all of them), on a 3x3 grid, five cards each, with rules that get nastier and nastier depending on the region. This minigame is an absolute blast, and shockingly easy to learn; winning once the rules turn nasty, though, is a whole different matter.",
    ffviiiFull38: "Welcome to the world of Final Fantasy VIII collecting. What's that, Pokémon? Forget it, you'll spend half your total playtime chasing after these cards without even noticing. And if you don't like it, that's on you.",
    ffviiiFull39: "All in all, this is a wonderful game in so many ways.",
    ffviiiFull40: "The graphical quality of the cutscenes still manages to hold up decently against today's games, with jaw-dropping sequences and moments that genuinely get you hyped, or even a little emotional. The music, on the other hand, is truly something else. Genuinely, ridiculously beautiful tracks; honestly, I'm struggling to even write coherently just thinking about how good they are. And then there's Eyes on Me, Julia's song performed by Faye Wong: the first time a Final Fantasy ever dared to put a real popstar inside a video game, talk about \"modern experimentation\" before it was cool. The SeeD exam scene at Dollet is proof of just how high both of those points reach (graphics and music). Personally, watching it, I was already sold, as far as I'm concerned that exam was already passed with flying colors.",
    ffviiiFull41: "Still, one of the most criticized aspects remains its plot holes, bad enough to make even Dark Souls blush; that's never stopped fans from hunting for answers, and sometimes making them up themselves. The ending, meanwhile, is a whole separate conversation: an absolute mess, a genuine acid trip.",
    ffviiiFull42: "One question that remains unresolved to this day, and still keeps countless fans debating, is Ultimecia's true identity: being a sorceress from the future, the theory goes that she could actually be a character already known in the present timeline of Final Fantasy VIII's events.",
    ffviiiFull43: "Over the years, candidates have included Squall, Zell, and Edea herself, each for their own reasons, but all of them promptly and spectacularly ruled out, for obvious reasons. Beyond them, though, there's one theory that's kept people talking for years, covered in full detail on the theories page. And who knows, maybe down the line you'll find a theory of my own on that very same page: nothing's decided yet, and I couldn't say when it'll happen, but let's just say the temptation is there.",
