...
const STRINGS = {
  it: {
    ...
    landingIntro: "Un archivio di storie tramutate in racconti brevi pensati per colpire in poche righe o libri a capitoli per chi non vuole più uscirne.",
    landingQuote: "Non so mai in anticipo se una storia vuole restare breve o crescere fino a diventare un libro intero. Ci vado dietro, e basta: a volte bastano poche righe, altre volte serve molto più tempo.",
  ...
  en: {
    ...
    landingIntro: "An archive of stories turned into short pieces built to land in a handful of lines, or chaptered books for those who don't want to leave.",
    landingQuote: "I never know in advance whether a story wants to stay short or grow into a full book. I just follow it: sometimes a few lines are enough, sometimes it takes much longer.",
    landingSignature: "— Sakrem",
