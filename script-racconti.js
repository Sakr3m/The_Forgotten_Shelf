...
const STRINGS = {
  it: {
    ...
    landingIntro: "Racconti raccoglie storie brevi originali e libri a capitoli: racconti autoconclusivi che spaziano tra horror psicologico, dark fantasy, elegia e altro ancora, pensati per essere letti in un'unica seduta o capitolo per capitolo.",
  ...
  en: {
    ...
    landingTitle: "The Forgotten Shelf",
    landingIntro: "Racconti collects original short stories and chaptered books: self-contained tales ranging from psychological horror to dark fantasy, elegy, and more — meant to be read in one sitting or chapter by chapter.",
