...
const STRINGS = {
  it: {
    ...
    railLabel: "Libri",
    landingEyebrow: "Benvenuto nell'archivio\ndi racconti e storie brevi",
    landingTitle: "The Forgotten Shelf",
    landingIntro: "The Forgotten Shelf raccoglie storie brevi originali e libri a capitoli: racconti autoconclusivi che spaziano tra horror psicologico, dark fantasy, elegia e altro ancora, pensati per essere letti in un'unica seduta o capitolo per capitolo.",
    spoilerAlert: "Alcuni racconti contengono temi intensi, colpi di scena o finali inaspettati. Leggili con questo in mente.",
  ...
  en: {
    ...
    landingTitle: "The Forgotten Shelf",
    landingIntro: "The Forgotten Shelf collects original short stories and chaptered books: self-contained tales ranging from psychological horror to dark fantasy, elegy, and more — meant to be read in one sitting or chapter by chapter.",
    spoilerAlert: "Some stories contain intense themes, twists, or unexpected endings. Keep that in mind as you read.",
