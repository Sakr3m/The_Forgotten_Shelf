...
const STRINGS = {
  it: {
    ...
    landingIntro: "Racconti brevi originali, storie nate per esistere e basta, solo un'idea portata fino in fondo, e libri a capitoli per chi cerca qualcosa di più esteso: horror psicologico, dark fantasy, elegia e altro ancora.",
  ...
  en: {
    ...
    landingIntro: "Original short stories — tales born to exist and nothing more, just an idea taken all the way — and chaptered books for those looking for something longer: psychological horror, dark fantasy, elegy, and more.",
...
function suonaTap(volume){
  if(tapAudioCtx && tapBuffer){
    ...
    tap.volume = volume;
    tap.play().catch(() => {});
    return null; // durata non nota in anticipo con questo metodo
  }
}
