...
const STRINGS = {
  it: {
    ...
    landingIntro: "Un archivio di racconti brevi pensati per colpire in poche righe o libri a capitoli per chi non vuole più uscirne.",
  ...
  en: {
    ...
    landingIntro: "An archive of short stories built to land in a handful of lines or chaptered books for those who don't want to leave.",
