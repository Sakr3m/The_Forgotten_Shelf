...
const state = { lang: "en", view: "landing", musicOn: false, trackIndex: 0, textSizeIndex: 0 };
...
function paintStaticText(){
  ...
  const isOpen = el.gateToggleRight.getAttribute("aria-expanded") === "true";
  el.gateToggleRight.setAttribute("aria-label", isOpen ? t("gateToggleLabelClose") : t("gateToggleLabel"));
...
// logica gia' usata su Racconti/Teorie/Timeline.
